		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Danger Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_danger" class="breadcrumb-item">Colors</a>
							<span class="breadcrumb-item active">Danger palette</span>
						</div>
			...
			<div class="content">
							...
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										...
										<div class="text-muted mt-1">#C62828</div>
									</div>

									<div class="list-icons">
				                		<a href="#danger_800" class="list-icons-item" data-toggle="modal">
							...
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										...
										<div class="text-muted mt-1">#D32F2F</div>
									</div>

									<div class="list-icons">
				                		<a href="#danger_700" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
							...
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										...
										<div class="text-muted mt-1">#E53935</div>
									</div>

									<div class="list-icons">
				                		<a href="#danger_600" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
							...
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										...
										<div class="text-muted mt-1">#F44336</div>
									</div>

									<div class="list-icons">
				                		<a href="#danger_500" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
							...
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										...
										<div class="text-muted mt-1">#EF5350</div>
									</div>

									<div class="list-icons">
				                		<a href="#danger_400" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
							...
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										...
										<div class="text-muted mt-1">#E57373</div>
									</div>

									<div class="list-icons">
				                		<a href="#danger_300" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
				...
				<div class="mb-3">
				    ...
				    <!-- White alert -->
					<div class="alert alert-danger bg-white alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						And this alert uses danger color palette, but white background color. With utility classes, everything is possible
				    </div>
				    <!-- /white alert -->
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.text-danger</code> classes</p>
							</div>

							<input type="text" class="form-control text-danger text-uppercase font-weight-semibold font-size-sm line-height-sm" value="Input field text">
						</div>
			    	</div>
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-danger">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-danger"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-danger"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-danger btn-icon" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.bg-danger</code> classes</p>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="danger-radio" checked data-fouc>
										Selected
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="danger-radio" data-fouc>
										Unselected
									</label>
								</div>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger">
							...
							<select class="form-control form-control-select2" data-container-css-class="text-danger" data-fouc>
			    ...
			    <div class="row">
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-solid bg-danger rounded-top border-0 mb-0">
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-danger rounded-top-0 border-top-1 mb-0">
			    ...
			    <div class="row">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<span class="badge bg-danger badge-pill">390</span>
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped bg-danger" style="width: 65%">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th>#</th>
											<th class="alpha-danger">First Name</th>
											<th>Last Name</th>
									...
									<tbody>
										<tr>
											<td>1</td>
											<td class="alpha-danger">Eugene</td>
											<td>Kopyov</td>
											<td class="bg-danger">@Kopyov</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="alpha-danger">Victoria</td>
											<td>Baker</td>
											<td class="bg-danger">@Vicky</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="alpha-danger">James</td>
											<td>Alexander</td>
											<td class="bg-danger">@Alex</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button type="button" class="btn bg-danger"><i class="icon-menu7 mr-2"></i> Button</button>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button type="button" class="btn bg-danger btn-labeled btn-labeled-left">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button type="button" class="btn btn-outline bg-danger text-danger border-danger">
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card">
							<div class="card-header bg-danger header-elements-inline">
								<h6 class="card-title">Danger card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Danger card using <code>.bg-danger</code> class added to the card header
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card border-1 border-danger">
							<div class="card-header header-elements-inline bg-danger">
								<h6 class="card-title">Danger bordered card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Bordered danger card using <code>.bg-danger</code> and <code>.border-danger</code> classes
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card bg-danger">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Danger solid card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Solid danger card using <code>.bg-danger</code> class added to the card container
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button type="button" class="btn bg-danger" data-popup="tooltip-custom" title="Danger tooltip" data-placement="bottom" data-container="body">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button type="button" class="btn bg-danger" data-popup="popover-custom" title="Danger popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover title
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button type="button" class="btn bg-danger" data-popup="popover-solid" title="Danger popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover background
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button type="button" class="btn bg-danger" data-toggle="modal" data-target="#modal_danger_header">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button type="button" class="btn bg-danger" data-toggle="modal" data-target="#modal_danger">
									<i class="icon-bubbles8 mr-2"></i>
									Modal background
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button type="button" class="btn bg-danger" data-toggle="modal" data-target="#modal_danger_footer">
									<i class="icon-bubbles8 mr-2"></i>
									Modal dialog footer
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<p class="mb-3 text-muted">Using <code>.bg-danger</code> color classes</p>

							<div>
								<button class="btn bg-danger noty-launch">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button class="btn bg-danger growl-launch">
									<i class="icon-bubbles6 mr-2"></i>
									jGrowl notification
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger text-center">
							...
							<div>
								<button class="btn bg-danger pnotify-launch">
									<i class="icon-bubbles6 mr-2"></i>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-danger</code> color classes</p>
							</div>

							<div class="dropdown-menu border-danger border-2" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-danger">
							...
							<div class="dropdown-menu bg-danger border-danger" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item"><i class="icon-menu7"></i> Action</a>
								<a href="#" class="dropdown-item"><i class="icon-screen-full"></i> Another action</a>
								<a href="#" class="dropdown-item"><i class="icon-mail5"></i> Something else here</a>
								<div class="dropdown-divider"></div>
			    		...
			    		<div class="card card-body border-top-danger">
							...
							<div class="dropdown-menu bg-danger border-danger" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item">
									<i class="icon-menu7"></i>
									Action
									<span class="badge bg-danger-800 ml-auto">Badge</span>
								</a>
								<a href="#" class="dropdown-item">
									<i class="icon-screen-full"></i>
									Another action
									<span class="badge badge-pill bg-danger-800 ml-auto">98</span>
								</a>
								<div class="dropdown-divider"></div>
				...
				<!-- Modal header -->
				<div id="modal_danger_header" class="modal fade">
					...
					<div class="modal-dialog">
						<div class="modal-content bg-danger">
							<div class="modal-header">
								<h6 class="modal-title">Danger background</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
				...
				<!-- Modal footer -->
				<div id="modal_danger_footer" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h6 class="modal-title">Danger footer</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>

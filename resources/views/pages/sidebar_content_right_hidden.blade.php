	...
	<div class="navbar navbar-expand-md navbar-dark bg-indigo navbar-static">
		...
		<div class="collapse navbar-collapse" id="navbar-mobile">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a href="#" class="navbar-nav-link sidebar-control sidebar-component-toggle d-none d-md-block" data-popup="tooltip-demo" title="Hide content sidebar" data-placement="bottom" data-container="body" data-trigger="hover">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Content Sidebar</span> - Right Hidden</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_content_right_hidden" class="breadcrumb-item">Content sidebar</a>
							<span class="breadcrumb-item active">Right hidden</span>
						</div>
				...
				<div class="d-flex flex-column flex-md-row">
					...
					<div class="order-2 order-md-1">
						...
						<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
							...
							<h6 class="alert-heading font-weight-semibold mb-1">Hidden content sidebar</h6>
							If for some reason you need to make content sidebar invisible by default, simply add <code>.sidebar-component-hidden</code> class to <code>&lt;body></code> container. Use <code>.sidebar-component-toggle</code> class in sidebar control button to toggle sidebar visibility.
					    </div>
					    <!-- /info alert -->
...
&lt;!-- /mini sidebar layout -->
					...
					<div class="sidebar sidebar-light sidebar-component sidebar-component-right order-1 order-md-2 sidebar-expand-md">

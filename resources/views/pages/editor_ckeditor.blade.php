			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Editors</span> - CKEditor</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="editor_ckeditor" class="breadcrumb-item">Editors</a>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control-select2" id="xEnter">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control-select2" id="xShiftEnter">

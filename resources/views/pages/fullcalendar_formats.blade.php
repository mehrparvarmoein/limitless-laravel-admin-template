...
<head>
	...
	<script src="../../../../global_assets/js/plugins/ui/fullcalendar/core/locales-all.min.js"></script>
	...
	<script src="../../../../global_assets/js/demo_pages/fullcalendar_formats.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Fullcalendar</span> - Formats</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="fullcalendar_formats" class="breadcrumb-item">Fullcalendar</a>
							<span class="breadcrumb-item active">Formats</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Internationalization</h5>
						<div class="header-elements">
							<form action="#">
								<div class="form-group mb-0">
									<select id="lang-selector" class="form-control form-control-select2" data-placeholder="Select language" data-fouc></select>
								</div>
							</form>
	                	</div>
					</div>
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Date formats</h5>
						<div class="header-elements">

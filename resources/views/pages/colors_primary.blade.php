...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/colors_primary.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Primary Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_primary" class="breadcrumb-item">Colors</a>
							<span class="breadcrumb-item active">Primary palette</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-primary-800 demo-color"><span>primary-800</span></div>

							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Primary 800</strong>
										<div class="text-muted mt-1">#1565C0</div>
									</div>

									<div class="list-icons">
				                		<a href="#primary_800" class="list-icons-item" data-toggle="modal">
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-primary-700 demo-color"><span>primary-700</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Primary 700</strong>
										<div class="text-muted mt-1">#1976D2</div>
									</div>

									<div class="list-icons">
				                		<a href="#primary_700" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-primary-600 demo-color"><span>primary-600</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Primary 600</strong>
										<div class="text-muted mt-1">#1E88E5</div>
									</div>

									<div class="list-icons">
				                		<a href="#primary_600" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-primary demo-color"><span>primary</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Primary 500</strong>
										<div class="text-muted mt-1">#2196F3</div>
									</div>

									<div class="list-icons">
				                		<a href="#primary_500" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-primary-400 demo-color"><span>primary-400</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Primary 400</strong>
										<div class="text-muted mt-1">#42A5F5</div>
									</div>

									<div class="list-icons">
				                		<a href="#primary_400" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-primary-300 demo-color"><span>primary-300</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Primary 300</strong>
										<div class="text-muted mt-1">#64B5F6</div>
									</div>

									<div class="list-icons">
				                		<a href="#primary_300" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
				...
				<div class="card">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td><code>.bg-primary</code><br><code>.bg-primary-*</code></td>
									<td>Classes for background color. You can choose between 1 primary color using <code>.bg-primary</code> class and 5 accent colors using <code>.bg-primary-*</code> class in 300, 400, 600, 700, 800 range</td>
								</tr>
								<tr>
									<td><code>.border-primary</code><br><code>.border-primary-*</code></td>
				...
				<div class="mb-3">
					...
					<div class="alert alert-primary alert-styled-left alert-dismissible">
						...
						Here you can see how primary palette can be used with different components. By the way, this alert uses it as well
				    </div>
				    <!-- /basic alert -->
					...
					<div class="alert alert-primary bg-white alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						And this alert uses primary color palette, but white background color. With utility classes, everything is possible
				    </div>
				    <!-- /white alert -->


				    <!-- Solid alert -->
				    <div class="alert bg-primary alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.text-primary</code> classes</p>
							</div>

							<input type="text" class="form-control text-primary text-uppercase font-weight-semibold font-size-sm line-height-sm" value="Input field text">
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary">
							...
							<div class="form-group-feedback form-group-feedback-right">
								...
								<div class="form-control-feedback text-primary">
									<i class="icon-help"></i>
								</div>
							</div>
						</div>
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-primary">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-primary"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-primary"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-primary btn-icon" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.bg-primary</code> classes</p>
							</div>
							...
							<div class="input-group">
								...
								<span class="input-group-append">
									<button class="btn bg-primary" type="button">Button</button>
								</span>									
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="primary-radio" checked data-fouc>
										Selected
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="primary-radio" data-fouc>
										Unselected
									</label>
								</div>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary">
							...
							<select class="form-control form-control-select2" data-container-css-class="text-primary" data-fouc>
			    ...
			    <div class="row">
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-solid bg-primary rounded-top border-0 mb-0">
								...
								<div class="tab-content card card-body rounded-top-0 mb-0">
									<div class="tab-pane fade active show" id="colored-nav-tab1">
										Add <code>custom</code> background color to the tab navigation with <code>.bg-primary</code> palette classes
									</div>
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-primary rounded-top-0 border-top-1 mb-0">
									<div class="tab-pane fade active show" id="colored-tab1">
										Add <code>custom</code> background color to the tabs navigation and content with <code>.bg-primary</code> palette classes
									</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<span class="text-primary">Primary text</span> and <a href="#" class="text-primary">primary link</a>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<span class="badge bg-primary badge-pill">390</span>
							</div>
						</div>
			    	</div>
			    </div>
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th>#</th>
											<th class="alpha-primary">First Name</th>
											<th>Last Name</th>
									...
									<tbody>
										<tr>
											<td>1</td>
											<td class="alpha-primary">Eugene</td>
											<td>Kopyov</td>
											<td class="bg-primary">@Kopyov</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="alpha-primary">Victoria</td>
											<td>Baker</td>
											<td class="bg-primary">@Vicky</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="alpha-primary">James</td>
											<td>Alexander</td>
											<td class="bg-primary">@Alex</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button type="button" class="btn bg-primary"><i class="icon-menu7 mr-2"></i> Button</button>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button type="button" class="btn bg-primary btn-labeled btn-labeled-left">
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card">
							...
							<div class="card-body">
								Primary card using <code>.bg-primary</code> class added to the card header
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card border-1 border-primary">
							<div class="card-header header-elements-inline bg-primary">
								<h6 class="card-title">Primary bordered card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Bordered primary card using <code>.bg-primary</code> and <code>.border-primary</code> classes
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card bg-primary">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Primary solid card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Solid primary card using <code>.bg-primary</code> class added to the card container
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button type="button" class="btn bg-primary" data-popup="tooltip-custom" title="Primary tooltip" data-placement="bottom" data-container="body">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button type="button" class="btn bg-primary" data-popup="popover-custom" title="Primary popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover title
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button type="button" class="btn bg-primary" data-popup="popover-solid" title="Primary popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover background
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button type="button" class="btn bg-primary" data-toggle="modal" data-target="#modal_primary_header">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button type="button" class="btn bg-primary" data-toggle="modal" data-target="#modal_primary">
									<i class="icon-bubbles8 mr-2"></i>
									Modal background
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button type="button" class="btn bg-primary" data-toggle="modal" data-target="#modal_primary_footer">
									<i class="icon-bubbles8 mr-2"></i>
									Modal dialog footer
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<p class="mb-3 text-muted">Using <code>.bg-primary</code> color classes</p>

							<div>
								<button class="btn bg-primary noty-launch">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button class="btn bg-primary growl-launch">
									<i class="icon-bubbles6 mr-2"></i>
									jGrowl notification
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary text-center">
							...
							<div>
								<button class="btn bg-primary pnotify-launch">
									<i class="icon-bubbles6 mr-2"></i>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-primary</code> color classes</p>
							</div>

							<div class="dropdown-menu border-primary border-2" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-primary">
							...
							<div class="dropdown-menu bg-primary border-primary" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item"><i class="icon-menu7"></i> Action</a>
								<a href="#" class="dropdown-item"><i class="icon-screen-full"></i> Another action</a>
								<a href="#" class="dropdown-item"><i class="icon-mail5"></i> Something else here</a>
								<div class="dropdown-divider"></div>
			    		...
			    		<div class="card card-body border-top-primary">
							...
							<div class="dropdown-menu bg-primary border-primary" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item">
									<i class="icon-menu7"></i>
									Action
									<span class="badge bg-primary-800 ml-auto">Badge</span>
								</a>
								<a href="#" class="dropdown-item">
									<i class="icon-screen-full"></i>
									Another action
									<span class="badge badge-pill bg-primary-800 ml-auto">98</span>
								</a>
								<div class="dropdown-divider"></div>
				...
				<!-- Modal header -->
				<div id="modal_primary_header" class="modal fade">
				...
				<!-- Solid modal -->
				<div id="modal_primary" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content bg-primary">
							<div class="modal-header">
								<h6 class="modal-title">Primary background</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
				...
				<!-- Modal footer -->
				<div id="modal_primary_footer" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h6 class="modal-title">Primary footer</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
	            ...
	            <!-- Primary 800 -->
				<div id="primary_800" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										...
										<td><code>.bg-primary-800</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-primary-800</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-primary-800</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-primary-800</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-primary-800</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-primary-800</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Primary 700 -->
				<div id="primary_700" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-primary-700</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-primary-700</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-primary-700</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-primary-700</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-primary-700</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Primary 600 -->
				<div id="primary_600" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tr>
										<td>Border color:</td>
										<td><code>.border-primary-600</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-primary-600</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-primary-600</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-primary-600</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-primary-600</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Primary 500 -->
				<div id="primary_500" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
	            ...
	            <!-- Primary 400 -->
				<div id="primary_400" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-primary-400</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-primary-400</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-primary-400</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-primary-400</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-primary-400</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-primary-400</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Primary 300 -->
				<div id="primary_300" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-primary-300</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-primary-300</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-primary-300</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-primary-300</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-primary-300</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-primary-300</code></td>
									</tr>
								</table>
							</div>

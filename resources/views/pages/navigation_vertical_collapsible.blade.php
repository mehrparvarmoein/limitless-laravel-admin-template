		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Vertical Nav</span> - Collapsible</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navigation_vertical_collapsible" class="breadcrumb-item">Vertical nav</a>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Collapsible navigation type</h6>
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Navigation types</h5>
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-6">
								<p class="font-weight-semibold">Collapsible type:</p>
									...
									<div class="sidebar-content position-static">
										...
										<div class="card">
											<ul class="nav nav-sidebar" data-nav-type="collapsible">
												...
												<li class="nav-item nav-item-submenu">
													<a href="#" class="nav-link disabled"><i class="icon-make-group"></i> Disabled levels</a>
								...
								<p class="font-weight-semibold">Collapsible type in child levels:</p>
									...
									<div class="sidebar-content position-static">
										...
										<div class="card">
											<ul class="nav nav-sidebar" data-nav-type="collapsible">
												...
												<li class="nav-item nav-item-submenu">
													<a href="#" class="nav-link"><i class="icon-cube3"></i> Multiple children</a>

													<ul class="nav nav-group-sub">
														<li class="nav-item"><a href="#" class="nav-link">Single item</a></li>
														<li class="nav-item nav-item-submenu">
							...
							<div class="col-md-6">
								<p class="font-weight-semibold">Accordion type:</p>
								<div class="sidebar sidebar-light sidebar-component position-static w-100 d-block mb-md-4">
									<div class="sidebar-content position-static">
								...
								<p class="font-weight-semibold">Accordion type in child levels:</p>
								<div class="sidebar sidebar-light sidebar-component position-static w-100 d-block mb-md-0">
									<div class="sidebar-content position-static">

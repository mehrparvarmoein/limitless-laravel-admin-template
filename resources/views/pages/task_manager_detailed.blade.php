			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Task Manager</span> - Detailed</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="task_manager_detailed" class="breadcrumb-item">Task manager</a>
					...
					<div class="w-100 overflow-auto order-2 order-md-1">
						...
						<div class="card">
							<div class="card-header header-elements-md-inline">
								<h5 class="card-title">#23: Support tickets list doesn't support commas</h5>
							...
							<div class="card-body">
								...
								<h6 class="font-weight-semibold">What we need</h6>
								...
								<div class="mb-4">
									<div class="media flex-column flex-md-row">
										<div class="mr-md-3 mb-2 mb-md-0">
											<a href="#"><img src="../../../../global_assets/images/placeholders/placeholder.jpg" class="rounded-circle" width="36" height="36" alt=""></a>
										</div>

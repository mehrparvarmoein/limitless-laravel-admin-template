...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/colors_info.js"></script>
	<!-- /Page JS files -->
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Info Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_info" class="breadcrumb-item">Colors</a>
							<span class="breadcrumb-item active">Info palette</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
							...
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										...
										<div class="text-muted mt-1">#00838F</div>
									</div>

									<div class="list-icons">
				                		<a href="#info_800" class="list-icons-item" data-toggle="modal">
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-info-700 demo-color"><span>info-700</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Info 700</strong>
										<div class="text-muted mt-1">#0097A7</div>
									</div>

									<div class="list-icons">
				                		<a href="#info_700" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-info-600 demo-color"><span>info-600</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Info 600</strong>
										<div class="text-muted mt-1">#00ACC1</div>
									</div>

									<div class="list-icons">
				                		<a href="#info_600" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-info demo-color"><span>info</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Info 500</strong>
										<div class="text-muted mt-1">#00BCD4</div>
									</div>

									<div class="list-icons">
				                		<a href="#info_500" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-info-400 demo-color"><span>info-400</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Info 400</strong>
										<div class="text-muted mt-1">#26C6DA</div>
									</div>

									<div class="list-icons">
				                		<a href="#info_400" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-info-300 demo-color"><span>info-300</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Info 300</strong>
										<div class="text-muted mt-1">#4DD0E1</div>
									</div>

									<div class="list-icons">
				                		<a href="#info_300" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
				...
				<div class="card">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td><code>.bg-info</code><br><code>.bg-info-*</code></td>
									<td>Classes for background color. You can choose between 1 info color using <code>.bg-info</code> class and 5 accent colors using <code>.bg-info-*</code> class in 300, 400, 600, 700, 800 range</td>
								</tr>
								<tr>
									<td><code>.border-info</code><br><code>.border-info-*</code></td>
				...
				<div class="mb-3">
					...
					<div class="alert alert-info alert-styled-left alert-dismissible">
						...
						Here you can see how info palette can be used with different components. By the way, this alert uses it as well
				    </div>
				    <!-- /basic alert -->
					...
					<div class="alert alert-info bg-white alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						And this alert uses info color palette, but white background color. With utility classes, everything is possible
				    </div>
				    <!-- /white alert -->
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.text-info</code> classes</p>
							</div>

							<input type="text" class="form-control text-info text-uppercase font-weight-semibold font-size-sm line-height-sm" value="Input field text">
						</div>
			    	</div>
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-info">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-info"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-info"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-info btn-icon" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.bg-info</code> classes</p>
							</div>
							...
							<div class="input-group">
								...
								<span class="input-group-append">
									<button class="btn bg-info" type="button">Button</button>
								</span>									
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="info-radio" checked data-fouc>
										Selected
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="info-radio" data-fouc>
										Unselected
									</label>
								</div>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info">
							...
							<select class="form-control form-control-select2" data-container-css-class="text-info" data-fouc>
			    ...
			    <div class="row">
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-solid bg-info rounded-top border-0 mb-0">
								...
								<div class="tab-content card card-body rounded-top-0 mb-0">
									<div class="tab-pane fade active show" id="colored-nav-tab1">
										Add <code>custom</code> background color to the tab navigation with <code>.bg-info</code> palette classes
									</div>
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-info rounded-top-0 border-top-1 mb-0">
									<div class="tab-pane fade active show" id="colored-tab1">
										Add <code>custom</code> background color to the tabs navigation and content with <code>.bg-info</code> palette classes
									</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<span class="text-info">Info text</span> and <a href="#" class="text-info">info link</a>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<span class="badge bg-info badge-pill">390</span>
							</div>
						</div>
			    	</div>
			    </div>
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th>#</th>
											<th class="alpha-info">First Name</th>
											<th>Last Name</th>
									...
									<tbody>
										<tr>
											<td>1</td>
											<td class="alpha-info">Eugene</td>
											<td>Kopyov</td>
											<td class="bg-info">@Kopyov</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="alpha-info">Victoria</td>
											<td>Baker</td>
											<td class="bg-info">@Vicky</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="alpha-info">James</td>
											<td>Alexander</td>
											<td class="bg-info">@Alex</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button type="button" class="btn bg-info"><i class="icon-menu7 mr-2"></i> Button</button>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button type="button" class="btn bg-info btn-labeled btn-labeled-left">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button type="button" class="btn btn-outline bg-info text-info border-info">
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card">
							<div class="card-header bg-info header-elements-inline">
								<h6 class="card-title">Info card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Info card using <code>.bg-info</code> class added to the card header
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card border-1 border-info">
							<div class="card-header header-elements-inline bg-info">
								<h6 class="card-title">Info bordered card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Bordered info card using <code>.bg-info</code> and <code>.border-info</code> classes
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card bg-info">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Info solid card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Solid info card using <code>.bg-info</code> class added to the card container
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button type="button" class="btn bg-info" data-popup="tooltip-custom" title="Info tooltip" data-placement="bottom" data-container="body">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button type="button" class="btn bg-info" data-popup="popover-custom" title="Info popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover title
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button type="button" class="btn bg-info" data-popup="popover-solid" title="Info popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover background
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button type="button" class="btn bg-info" data-toggle="modal" data-target="#modal_info_header">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button type="button" class="btn bg-info" data-toggle="modal" data-target="#modal_info">
									<i class="icon-bubbles8 mr-2"></i>
									Modal background
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button type="button" class="btn bg-info" data-toggle="modal" data-target="#modal_info_footer">
									<i class="icon-bubbles8 mr-2"></i>
									Modal dialog footer
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<p class="mb-3 text-muted">Using <code>.bg-info</code> color classes</p>

							<div>
								<button class="btn bg-info noty-launch">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button class="btn bg-info growl-launch">
									<i class="icon-bubbles6 mr-2"></i>
									jGrowl notification
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info text-center">
							...
							<div>
								<button class="btn bg-info pnotify-launch">
									<i class="icon-bubbles6 mr-2"></i>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-info</code> color classes</p>
							</div>

							<div class="dropdown-menu border-info border-2" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-info">
							...
							<div class="dropdown-menu bg-info border-info" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item"><i class="icon-menu7"></i> Action</a>
								<a href="#" class="dropdown-item"><i class="icon-screen-full"></i> Another action</a>
								<a href="#" class="dropdown-item"><i class="icon-mail5"></i> Something else here</a>
								<div class="dropdown-divider"></div>
			    		...
			    		<div class="card card-body border-top-info">
							...
							<div class="dropdown-menu bg-info border-info" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item">
									<i class="icon-menu7"></i>
									Action
									<span class="badge bg-info-800 ml-auto">Badge</span>
								</a>
								<a href="#" class="dropdown-item">
									<i class="icon-screen-full"></i>
									Another action
									<span class="badge badge-pill bg-info-800 ml-auto">98</span>
								</a>
								<div class="dropdown-divider"></div>
				...
				<!-- Modal header -->
				<div id="modal_info_header" class="modal fade">
					...
					<div class="modal-dialog">
						<div class="modal-content bg-info">
							<div class="modal-header">
								<h6 class="modal-title">Info background</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
				...
				<!-- Modal footer -->
				<div id="modal_info_footer" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h6 class="modal-title">Info footer</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										...
										<td><code>.bg-info-800</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-info-800</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-info-800</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-info-800</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-info-800</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-info-800</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Info 700 -->
				<div id="info_700" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-info-700</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-info-700</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-info-700</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-info-700</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-info-700</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-info-700</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Info 600 -->
				<div id="info_600" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-info-600</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-info-600</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-info-600</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-info-600</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-info-600</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-info-600</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Info 500 -->
				<div id="info_500" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-info</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-info</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-info</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Info 400 -->
				<div id="info_400" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-info-400</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-info-400</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-info-400</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-info-400</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-info-400</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-info-400</code></td>
									</tr>
								</table>
							</div>
						...
						<div class="modal-content">
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-info-300</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-info-300</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-info-300</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-info-300</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-info-300</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-info-300</code></td>
									</tr>
								</table>
							</div>

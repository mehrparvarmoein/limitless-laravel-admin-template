			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Horizontal Nav</span> - On Click</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navigation_horizontal_click" class="breadcrumb-item">Horizontal nav</a>
							<span class="breadcrumb-item active">On click</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="pb-1">
							<p class="font-weight-semibold">Light navbar menus (click trigger):</p>
						...
						<p class="font-weight-semibold">Dark navbar menus (click trigger):</p>

		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Secondary and Main</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_secondary_before" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Secondary and main</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Secondary before main</h6>
					Secondary sidebar can be also placed before main sidebar - this layout doesn't require any classes, just swap sidebar markup and add other classes if needed.
			    </div>
			    <!-- /info alert -->

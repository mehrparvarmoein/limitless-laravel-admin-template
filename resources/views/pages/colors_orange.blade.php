...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/colors_orange.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Orange Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_orange" class="breadcrumb-item">Colors</a>
							<span class="breadcrumb-item active">Orange palette</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-orange-800 demo-color"><span>orange-800</span></div>

							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Orange 800</strong>
										<div class="text-muted mt-1">#EF6C00</div>
									</div>

									<div class="list-icons">
				                		<a href="#orange_800" class="list-icons-item" data-toggle="modal">
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-orange-700 demo-color"><span>orange-700</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Orange 700</strong>
										<div class="text-muted mt-1">#F57C00</div>
									</div>

									<div class="list-icons">
				                		<a href="#orange_700" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-orange-600 demo-color"><span>orange-600</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Orange 600</strong>
										<div class="text-muted mt-1">#FB8C00</div>
									</div>

									<div class="list-icons">
				                		<a href="#orange_600" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-orange demo-color"><span>orange</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Orange 500</strong>
										<div class="text-muted mt-1">#FF9800</div>
									</div>

									<div class="list-icons">
				                		<a href="#orange_500" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-orange-400 demo-color"><span>orange-400</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Orange 400</strong>
										<div class="text-muted mt-1">#FFA726</div>
									</div>

									<div class="list-icons">
				                		<a href="#orange_400" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-orange-300 demo-color"><span>orange-300</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Orange 300</strong>
										<div class="text-muted mt-1">#FFB74D</div>
									</div>

									<div class="list-icons">
				                		<a href="#orange_300" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
				...
				<div class="card">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td><code>.bg-orange</code><br><code>.bg-orange-*</code></td>
									<td>Classes for background color. You can choose between 1 orange color using <code>.bg-orange</code> class and 5 accent colors using <code>.bg-orange-*</code> class in 300, 400, 600, 700, 800 range</td>
								</tr>
								<tr>
									<td><code>.border-orange</code><br><code>.border-orange-*</code></td>
				...
				<div class="mb-3">
					...
					<!-- Basic alert -->
					<div class="alert alpha-orange border-orange text-orange-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						Here you can see how orange palette can be used with different components. By the way, this alert uses it as well
				    </div>
				    <!-- /basic alert -->


				    <!-- White alert -->
					<div class="alert bg-white border-orange text-orange-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						And this alert uses orange color palette, but white background color. With utility classes, everything is possible
				    </div>
				    <!-- /white alert -->


				    <!-- Solid alert -->
				    <div class="alert bg-orange alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange">
							<div class="text-center">
								<h6 class="m-0 font-weight-semibold">Input field text</h6>
								<p class="mb-3 text-muted">Using <code>.text-orange</code> classes</p>
							</div>

							<input type="text" class="form-control text-orange text-uppercase font-weight-semibold font-size-sm line-height-sm" value="Input field text">
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange">
							...
							<div class="form-group-feedback form-group-feedback-right">
								...
								<div class="form-control-feedback text-orange">
									<i class="icon-help"></i>
								</div>
							</div>
						</div>
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-orange">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-orange"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-orange"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-orange btn-icon" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.bg-orange</code> classes</p>
							</div>
							...
							<div class="input-group">
								...
								<span class="input-group-append">
									<button class="btn bg-orange" type="button">Button</button>
								</span>									
							</div>
						</div>
			    	</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="orange-radio" checked data-fouc>
										Selected
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="orange-radio" data-fouc>
										Unselected
									</label>
								</div>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange">
							...
							<select class="form-control form-control-select2" data-container-css-class="text-orange" data-fouc>
			    ...
			    <div class="row">
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-solid bg-orange rounded-top border-0 mb-0">
								...
								<div class="tab-content card card-body rounded-top-0 mb-0">
									<div class="tab-pane fade active show" id="colored-nav-tab1">
										Add <code>custom</code> background color to the tab navigation with <code>.bg-orange</code> palette classes
									</div>
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-orange rounded-top-0 border-top-1 mb-0">
									<div class="tab-pane fade active show" id="colored-tab1">
										Add <code>custom</code> background color to the tabs navigation and content with <code>.bg-orange</code> palette classes
									</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<span class="text-orange">Orange text</span> and <a href="#" class="text-orange">orange link</a>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<span class="badge bg-orange">Orange badge</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<span class="badge bg-orange badge-pill">390</span>
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div class="progress">
								<div class="progress-bar bg-orange" style="width: 55%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped bg-orange" style="width: 65%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped progress-bar-animated bg-orange" style="width: 75%">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th>#</th>
											<th class="alpha-orange">First Name</th>
											<th>Last Name</th>
											<th class="bg-orange">Username</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td>1</td>
											<td class="alpha-orange">Eugene</td>
											<td>Kopyov</td>
											<td class="bg-orange">@Kopyov</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="alpha-orange">Victoria</td>
											<td>Baker</td>
											<td class="bg-orange">@Vicky</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="alpha-orange">James</td>
											<td>Alexander</td>
											<td class="bg-orange">@Alex</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button type="button" class="btn bg-orange"><i class="icon-menu7 mr-2"></i> Button</button>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button type="button" class="btn bg-orange btn-labeled btn-labeled-left">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button type="button" class="btn btn-outline bg-orange text-orange border-orange">
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card">
							<div class="card-header bg-orange header-elements-inline">
								<h6 class="card-title">Orange card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Orange card using <code>.bg-orange</code> class added to the card header
							</div>
						</div>
			    	</div>

			    	<div class="col-md-4">
			    		<div class="card border-1 border-orange">
							<div class="card-header header-elements-inline bg-orange">
								<h6 class="card-title">Orange bordered card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Bordered orange card using <code>.bg-orange</code> and <code>.border-orange</code> classes
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card bg-orange">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Orange solid card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Solid orange card using <code>.bg-orange</code> class added to the card container
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button type="button" class="btn bg-orange" data-popup="tooltip-custom" title="Orange tooltip" data-placement="bottom" data-container="body">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button type="button" class="btn bg-orange" data-popup="popover-custom" title="Orange popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover title
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button type="button" class="btn bg-orange" data-popup="popover-solid" title="Orange popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover background
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button type="button" class="btn bg-orange" data-toggle="modal" data-target="#modal_orange_header">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button type="button" class="btn bg-orange" data-toggle="modal" data-target="#modal_orange">
									<i class="icon-bubbles8 mr-2"></i>
									Modal background
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button type="button" class="btn bg-orange" data-toggle="modal" data-target="#modal_orange_footer">
									<i class="icon-bubbles8 mr-2"></i>
									Modal dialog footer
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<p class="mb-3 text-muted">Using <code>.bg-orange</code> color classes</p>

							<div>
								<button class="btn bg-orange noty-launch">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button class="btn bg-orange growl-launch">
									<i class="icon-bubbles6 mr-2"></i>
									jGrowl notification
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange text-center">
							...
							<div>
								<button class="btn bg-orange pnotify-launch">
									<i class="icon-bubbles6 mr-2"></i>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-orange</code> color classes</p>
							</div>

							<div class="dropdown-menu border-orange border-2" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-orange">
							...
							<div class="dropdown-menu bg-orange border-orange" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item"><i class="icon-menu7"></i> Action</a>
								<a href="#" class="dropdown-item"><i class="icon-screen-full"></i> Another action</a>
								<a href="#" class="dropdown-item"><i class="icon-mail5"></i> Something else here</a>
								<div class="dropdown-divider"></div>
			    		...
			    		<div class="card card-body border-top-orange">
							...
							<div class="dropdown-menu bg-orange border-orange" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item">
									<i class="icon-menu7"></i>
									Action
									<span class="badge bg-orange-800 ml-auto">Badge</span>
								</a>
								<a href="#" class="dropdown-item">
									<i class="icon-screen-full"></i>
									Another action
									<span class="badge badge-pill bg-orange-800 ml-auto">98</span>
								</a>
								<div class="dropdown-divider"></div>
				...
				<!-- Modal header -->
				<div id="modal_orange_header" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-orange">
								<h6 class="modal-title">Orange header</h6>
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn bg-orange">Save changes</button>
							</div>
						</div>
					</div>
				</div>
				...
				<!-- Solid modal -->
				<div id="modal_orange" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content bg-orange">
							<div class="modal-header">
								<h6 class="modal-title">Orange background</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
				...
				<!-- Modal footer -->
				<div id="modal_orange_footer" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h6 class="modal-title">Orange footer</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
	            ...
	            <!-- Orange 800 -->
				<div id="orange_800" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										...
										<td><code>.bg-orange-800</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-orange-800</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-orange-800</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-orange-800</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-orange-800</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-orange-800</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Orange 700 -->
				<div id="orange_700" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-orange-700</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-orange-700</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-orange-700</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-orange-700</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-orange-700</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Orange 600 -->
				<div id="orange_600" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-orange-600</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-orange-600</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-orange-600</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-orange-600</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-orange-600</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-orange-600</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Orange 500 -->
				<div id="orange_500" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-orange</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-orange</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-orange</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-orange</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-orange</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Orange 400 -->
				<div id="orange_400" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-orange-400</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-orange-400</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-orange-400</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-orange-400</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-orange-400</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-orange-400</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Orange 300 -->
				<div id="orange_300" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-orange-300</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-orange-300</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-orange-300</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-orange-300</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-orange-300</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-orange-300</code></td>
									</tr>
								</table>
							</div>

...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/colors_blue.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Blue Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_blue" class="breadcrumb-item">Colors</a>
							<span class="breadcrumb-item active">Blue palette</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-blue-800 demo-color"><span>blue-800</span></div>

							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Blue 800</strong>
										<div class="text-muted mt-1">#0277BD</div>
									</div>

									<div class="list-icons">
				                		<a href="#blue_800" class="list-icons-item" data-toggle="modal">
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-blue-700 demo-color"><span>blue-700</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Blue 700</strong>
										<div class="text-muted mt-1">#0288D1</div>
									</div>

									<div class="list-icons">
				                		<a href="#blue_700" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-blue-600 demo-color"><span>blue-600</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Blue 600</strong>
										<div class="text-muted mt-1">#039BE5</div>
									</div>

									<div class="list-icons">
				                		<a href="#blue_600" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-blue demo-color"><span>blue</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Blue 500</strong>
										<div class="text-muted mt-1">#03A9F4</div>
									</div>

									<div class="list-icons">
				                		<a href="#blue_500" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-blue-400 demo-color"><span>blue-400</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Blue 400</strong>
										<div class="text-muted mt-1">#29B6F6</div>
									</div>

									<div class="list-icons">
				                		<a href="#blue_400" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-blue-300 demo-color"><span>blue-300</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Blue 300</strong>
										<div class="text-muted mt-1">#4FC3F7</div>
									</div>

									<div class="list-icons">
				                		<a href="#blue_300" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
				...
				<div class="card">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td><code>.bg-blue</code><br><code>.bg-blue-*</code></td>
									<td>Classes for background color. You can choose between 1 blue color using <code>.bg-blue</code> class and 5 accent colors using <code>.bg-blue-*</code> class in 300, 400, 600, 700, 800 range</td>
								</tr>
								<tr>
									<td><code>.border-blue</code><br><code>.border-blue-*</code></td>
				...
				<div class="mb-3">
					...
					<!-- Basic alert -->
					<div class="alert alpha-blue border-blue text-blue-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						Here you can see how blue palette can be used with different components. By the way, this alert uses it as well
				    </div>
				    <!-- /basic alert -->


				    <!-- White alert -->
					<div class="alert bg-white border-blue text-blue-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						And this alert uses blue color palette, but white background color. With utility classes, everything is possible
				    </div>
				    <!-- /white alert -->


				    <!-- Solid alert -->
				    <div class="alert bg-blue alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.text-blue</code> classes</p>
							</div>

							<input type="text" class="form-control text-blue text-uppercase font-weight-semibold font-size-sm line-height-sm" value="Input field text">
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<div class="form-group-feedback form-group-feedback-right">
								...
								<div class="form-control-feedback text-blue">
									<i class="icon-help"></i>
								</div>
							</div>
						</div>
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-blue">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-blue"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-blue"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-blue btn-icon" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.bg-blue</code> classes</p>
							</div>
							...
							<div class="input-group">
								...
								<span class="input-group-append">
									<button class="btn bg-blue" type="button">Button</button>
								</span>									
							</div>
						</div>
			    	</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="blue-radio" checked data-fouc>
										Selected
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="blue-radio" data-fouc>
										Unselected
									</label>
								</div>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<select class="form-control form-control-select2" data-container-css-class="text-blue" data-fouc>
			    ...
			    <div class="row">
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-solid bg-blue rounded-top border-0 mb-0">
								...
								<div class="tab-content card card-body rounded-top-0 mb-0">
									<div class="tab-pane fade active show" id="colored-nav-tab1">
										Add <code>custom</code> background color to the tab navigation with <code>.bg-blue</code> palette classes
									</div>
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-blue rounded-top-0 border-top-1 mb-0">
									<div class="tab-pane fade active show" id="colored-tab1">
										Add <code>custom</code> background color to the tabs navigation and content with <code>.bg-blue</code> palette classes
									</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<span class="text-blue">Blue text</span> and <a href="#" class="text-blue">blue link</a>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<span class="badge bg-blue">Blue badge</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<span class="badge bg-blue badge-pill">390</span>
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div class="progress">
								<div class="progress-bar bg-blue" style="width: 55%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped bg-blue" style="width: 65%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped progress-bar-animated bg-blue" style="width: 75%">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th>#</th>
											<th class="alpha-blue">First Name</th>
											<th>Last Name</th>
											<th class="bg-blue">Username</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td>1</td>
											<td class="alpha-blue">Eugene</td>
											<td>Kopyov</td>
											<td class="bg-blue">@Kopyov</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="alpha-blue">Victoria</td>
											<td>Baker</td>
											<td class="bg-blue">@Vicky</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="alpha-blue">James</td>
											<td>Alexander</td>
											<td class="bg-blue">@Alex</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button type="button" class="btn bg-blue"><i class="icon-menu7 mr-2"></i> Button</button>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button type="button" class="btn bg-blue btn-labeled btn-labeled-left">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button type="button" class="btn btn-outline bg-blue text-blue border-blue">
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card">
							<div class="card-header bg-blue header-elements-inline">
								<h6 class="card-title">Blue card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Blue card using <code>.bg-blue</code> class added to the card header
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card border-1 border-blue">
							<div class="card-header header-elements-inline bg-blue">
								<h6 class="card-title">Blue bordered card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Bordered blue card using <code>.bg-blue</code> and <code>.border-blue</code> classes
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card bg-blue">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Blue solid card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Solid blue card using <code>.bg-blue</code> class added to the card container
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button type="button" class="btn bg-blue" data-popup="tooltip-custom" title="Blue tooltip" data-placement="bottom" data-container="body">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button type="button" class="btn bg-blue" data-popup="popover-custom" title="Blue popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover title
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button type="button" class="btn bg-blue" data-popup="popover-solid" title="Blue popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover background
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button type="button" class="btn bg-blue" data-toggle="modal" data-target="#modal_blue_header">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button type="button" class="btn bg-blue" data-toggle="modal" data-target="#modal_blue">
									<i class="icon-bubbles8 mr-2"></i>
									Modal background
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button type="button" class="btn bg-blue" data-toggle="modal" data-target="#modal_blue_footer">
									<i class="icon-bubbles8 mr-2"></i>
									Modal dialog footer
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<p class="mb-3 text-muted">Using <code>.bg-blue</code> color classes</p>

							<div>
								<button class="btn bg-blue noty-launch">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button class="btn bg-blue growl-launch">
									<i class="icon-bubbles6 mr-2"></i>
									jGrowl notification
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue text-center">
							...
							<div>
								<button class="btn bg-blue pnotify-launch">
									<i class="icon-bubbles6 mr-2"></i>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-blue</code> color classes</p>
							</div>

							<div class="dropdown-menu border-blue border-2" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<div class="dropdown-menu bg-blue border-blue" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item"><i class="icon-menu7"></i> Action</a>
								<a href="#" class="dropdown-item"><i class="icon-screen-full"></i> Another action</a>
								<a href="#" class="dropdown-item"><i class="icon-mail5"></i> Something else here</a>
								<div class="dropdown-divider"></div>
			    		...
			    		<div class="card card-body border-top-blue">
							...
							<div class="dropdown-menu bg-blue border-blue" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item">
									<i class="icon-menu7"></i>
									Action
									<span class="badge bg-blue-800 ml-auto">Badge</span>
								</a>
								<a href="#" class="dropdown-item">
									<i class="icon-screen-full"></i>
									Another action
									<span class="badge badge-pill bg-blue-800 ml-auto">98</span>
								</a>
								<div class="dropdown-divider"></div>
				...
				<!-- Modal header -->
				<div id="modal_blue_header" class="modal fade">
					...
					<div class="modal-dialog">
						<div class="modal-content bg-blue">
							<div class="modal-header">
								<h6 class="modal-title">Blue background</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
				...
				<!-- Modal footer -->
				<div id="modal_blue_footer" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h6 class="modal-title">Blue footer</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										...
										<td><code>.bg-blue-800</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-blue-800</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-blue-800</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-blue-800</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-blue-800</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-blue-800</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Blue 700 -->
				<div id="blue_700" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-blue-700</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-blue-700</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-blue-700</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-blue-700</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-blue-700</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Blue 600 -->
				<div id="blue_600" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-blue-600</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-blue-600</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-blue-600</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-blue-600</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-blue-600</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-blue-600</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Blue 500 -->
				<div id="blue_500" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tr>
										<td>Border color:</td>
										<td><code>.border-blue</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-blue</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-blue</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-blue</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Blue 400 -->
				<div id="blue_400" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-blue-400</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-blue-400</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-blue-400</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-blue-400</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-blue-400</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-blue-400</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Blue 300 -->
				<div id="blue_300" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-blue-300</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-blue-300</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-blue-300</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-blue-300</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-blue-300</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-blue-300</code></td>
									</tr>
								</table>
							</div>

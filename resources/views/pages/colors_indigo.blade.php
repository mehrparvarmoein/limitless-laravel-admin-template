...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/colors_indigo.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Indigo Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_indigo" class="breadcrumb-item">Colors</a>
							<span class="breadcrumb-item active">Indigo palette</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-indigo-800 demo-color"><span>indigo-800</span></div>

							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Indigo 800</strong>
										<div class="text-muted mt-1">#283593</div>
									</div>

									<div class="list-icons">
				                		<a href="#indigo_800" class="list-icons-item" data-toggle="modal">
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-indigo-700 demo-color"><span>indigo-700</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Indigo 700</strong>
										<div class="text-muted mt-1">#303F9F</div>
									</div>

									<div class="list-icons">
				                		<a href="#indigo_700" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-indigo-600 demo-color"><span>indigo-600</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Indigo 600</strong>
										<div class="text-muted mt-1">#3949AB</div>
									</div>

									<div class="list-icons">
				                		<a href="#indigo_600" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-indigo demo-color"><span>indigo</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Indigo 500</strong>
										<div class="text-muted mt-1">#3F51B5</div>
									</div>

									<div class="list-icons">
				                		<a href="#indigo_500" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-indigo-400 demo-color"><span>indigo-400</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Indigo 400</strong>
										<div class="text-muted mt-1">#5C6BC0</div>
									</div>

									<div class="list-icons">
				                		<a href="#indigo_400" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-indigo-300 demo-color"><span>indigo-300</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Indigo 300</strong>
										<div class="text-muted mt-1">#7986CB</div>
									</div>

									<div class="list-icons">
				                		<a href="#indigo_300" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
				...
				<div class="card">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td><code>.bg-indigo</code><br><code>.bg-indigo-*</code></td>
									<td>Classes for background color. You can choose between 1 indigo color using <code>.bg-indigo</code> class and 5 accent colors using <code>.bg-indigo-*</code> class in 300, 400, 600, 700, 800 range</td>
								</tr>
								<tr>
									<td><code>.border-indigo</code><br><code>.border-indigo-*</code></td>
				...
				<div class="mb-3">
					...
					<!-- Basic alert -->
					<div class="alert alpha-indigo border-indigo text-indigo-800 alert-styled-left alert-dismissible">
				    ...
				    <!-- White alert -->
					<div class="alert bg-white border-indigo text-indigo-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
				    ...
				    <!-- Solid alert -->
				    <div class="alert bg-indigo alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo">
							<div class="text-center">
								<h6 class="m-0 font-weight-semibold">Input field text</h6>
								<p class="mb-3 text-muted">Using <code>.text-indigo</code> classes</p>
							</div>

							<input type="text" class="form-control text-indigo text-uppercase font-weight-semibold font-size-sm line-height-sm" value="Input field text">
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo">
							...
							<div class="form-group-feedback form-group-feedback-right">
								...
								<div class="form-control-feedback text-indigo">
									<i class="icon-help"></i>
								</div>
							</div>
						</div>
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-indigo">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-indigo"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-indigo"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-indigo btn-icon" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.bg-indigo</code> classes</p>
							</div>
							...
							<div class="input-group">
								...
								<span class="input-group-append">
									<button class="btn bg-indigo" type="button">Button</button>
								</span>									
							</div>
						</div>
			    	</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="indigo-radio" checked data-fouc>
										Selected
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="indigo-radio" data-fouc>
										Unselected
									</label>
								</div>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo">
							...
							<select class="form-control form-control-select2" data-container-css-class="text-indigo" data-fouc>
			    ...
			    <div class="row">
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-solid bg-indigo rounded-top border-0 mb-0">
								...
								<div class="tab-content card card-body rounded-top-0 mb-0">
									<div class="tab-pane fade active show" id="colored-nav-tab1">
										Add <code>custom</code> background color to the tab navigation with <code>.bg-indigo</code> palette classes
									</div>
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-indigo rounded-top-0 border-top-1 mb-0">
									<div class="tab-pane fade active show" id="colored-tab1">
										Add <code>custom</code> background color to the tabs navigation and content with <code>.bg-indigo</code> palette classes
									</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<span class="text-indigo">Indigo text</span> and <a href="#" class="text-indigo">indigo link</a>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<span class="badge bg-indigo">Indigo badge</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<span class="badge bg-indigo badge-pill">390</span>
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div class="progress">
								<div class="progress-bar bg-indigo" style="width: 55%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped bg-indigo" style="width: 65%">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th>#</th>
											<th class="alpha-indigo">First Name</th>
											<th>Last Name</th>
											<th class="bg-indigo">Username</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td>1</td>
											<td class="alpha-indigo">Eugene</td>
											<td>Kopyov</td>
											<td class="bg-indigo">@Kopyov</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="alpha-indigo">Victoria</td>
											<td>Baker</td>
											<td class="bg-indigo">@Vicky</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="alpha-indigo">James</td>
											<td>Alexander</td>
											<td class="bg-indigo">@Alex</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button type="button" class="btn bg-indigo"><i class="icon-menu7 mr-2"></i> Button</button>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button type="button" class="btn bg-indigo btn-labeled btn-labeled-left">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button type="button" class="btn btn-outline bg-indigo text-indigo border-indigo">
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card">
							<div class="card-header bg-indigo header-elements-inline">
								<h6 class="card-title">Indigo card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Indigo card using <code>.bg-indigo</code> class added to the card header
							</div>
						</div>
			    	</div>

			    	<div class="col-md-4">
			    		<div class="card border-1 border-indigo">
							<div class="card-header header-elements-inline bg-indigo">
								<h6 class="card-title">Indigo bordered card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Bordered indigo card using <code>.bg-indigo</code> and <code>.border-indigo</code> classes
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card bg-indigo">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Indigo solid card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Solid indigo card using <code>.bg-indigo</code> class added to the card container
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button type="button" class="btn bg-indigo" data-popup="tooltip-custom" title="Indigo tooltip" data-placement="bottom" data-container="body">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button type="button" class="btn bg-indigo" data-popup="popover-custom" title="Indigo popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover title
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button type="button" class="btn bg-indigo" data-popup="popover-solid" title="Indigo popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover background
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button type="button" class="btn bg-indigo" data-toggle="modal" data-target="#modal_indigo_header">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button type="button" class="btn bg-indigo" data-toggle="modal" data-target="#modal_indigo">
									<i class="icon-bubbles8 mr-2"></i>
									Modal background
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button type="button" class="btn bg-indigo" data-toggle="modal" data-target="#modal_indigo_footer">
									<i class="icon-bubbles8 mr-2"></i>
									Modal dialog footer
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<p class="mb-3 text-muted">Using <code>.bg-indigo</code> color classes</p>

							<div>
								<button class="btn bg-indigo noty-launch">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button class="btn bg-indigo growl-launch">
									<i class="icon-bubbles6 mr-2"></i>
									jGrowl notification
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo text-center">
							...
							<div>
								<button class="btn bg-indigo pnotify-launch">
									<i class="icon-bubbles6 mr-2"></i>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-indigo</code> color classes</p>
							</div>

							<div class="dropdown-menu border-indigo border-2" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-indigo">
							...
							<div class="dropdown-menu bg-indigo border-indigo" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item"><i class="icon-menu7"></i> Action</a>
								<a href="#" class="dropdown-item"><i class="icon-screen-full"></i> Another action</a>
								<a href="#" class="dropdown-item"><i class="icon-mail5"></i> Something else here</a>
								<div class="dropdown-divider"></div>
			    		...
			    		<div class="card card-body border-top-indigo">
							...
							<div class="dropdown-menu bg-indigo border-indigo" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item">
									<i class="icon-menu7"></i>
									Action
									<span class="badge bg-indigo-800 ml-auto">Badge</span>
								</a>
								<a href="#" class="dropdown-item">
									<i class="icon-screen-full"></i>
									Another action
									<span class="badge badge-pill bg-indigo-800 ml-auto">98</span>
								</a>
								<div class="dropdown-divider"></div>
				...
				<!-- Modal header -->
				<div id="modal_indigo_header" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-indigo">
								<h6 class="modal-title">Indigo header</h6>
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn bg-indigo">Save changes</button>
							</div>
						</div>
					</div>
				</div>
				...
				<!-- Solid modal -->
				<div id="modal_indigo" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content bg-indigo">
							<div class="modal-header">
								<h6 class="modal-title">Indigo background</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
				...
				<!-- Modal footer -->
				<div id="modal_indigo_footer" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h6 class="modal-title">Indigo footer</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
							...
							<div class="modal-footer bg-indigo">
								<button type="button" class="btn btn-link text-white" data-dismiss="modal">Close</button>
								<button type="button" class="btn btn-outline bg-white border-white text-white">Save changes</button>
							</div>
						</div>
	            ...
	            <!-- Indigo 800 -->
				<div id="indigo_800" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										...
										<td><code>.bg-indigo-800</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-indigo-800</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-indigo-800</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-indigo-800</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-indigo-800</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-indigo-800</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Indigo 700 -->
				<div id="indigo_700" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-indigo-700</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-indigo-700</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-indigo-700</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-indigo-700</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-indigo-700</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Indigo 600 -->
				<div id="indigo_600" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-indigo-600</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-indigo-600</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-indigo-600</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-indigo-600</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-indigo-600</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-indigo-600</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Indigo 500 -->
				<div id="indigo_500" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-indigo</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Indigo 400 -->
				<div id="indigo_400" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-indigo-400</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-indigo-400</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-indigo-400</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-indigo-400</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-indigo-400</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-indigo-400</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Indigo 300 -->
				<div id="indigo_300" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-indigo-300</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-indigo-300</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-indigo-300</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-indigo-300</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-indigo-300</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-indigo-300</code></td>
									</tr>
								</table>
							</div>

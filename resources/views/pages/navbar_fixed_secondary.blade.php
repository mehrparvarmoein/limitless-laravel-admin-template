...
<body>
	...
	<!-- Alternative navbar -->
	<div class="navbar navbar-expand-md navbar-light navbar-static navbar-sticky">
		...
		<div class="navbar-collapse collapse" id="navbar-second">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a href="#" class="navbar-nav-link">
						Link width badge
						<span class="badge badge-pill bg-indigo-400 position-static ml-auto ml-md-2">5</span>
					</a>
				</li>
				<li class="nav-item dropdown">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Starters</span> - Navbar Fixed Secondary</h4>

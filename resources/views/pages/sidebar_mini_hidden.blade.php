...
<body class="sidebar-xs sidebar-main-hidden">
	...
	<div class="navbar navbar-expand-md navbar-dark bg-indigo navbar-static">
		...
		<div class="collapse navbar-collapse" id="navbar-mobile">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a href="#" class="navbar-nav-link sidebar-control sidebar-main-hide d-none d-md-block" data-popup="tooltip-demo" title="Show mini" data-placement="bottom" data-container="body" data-trigger="hover">
						<i class="icon-lan3"></i>
					</a>
				</li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Mini Hidden</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_mini_hidden" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Mini hidden</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Hidden mini sidebar</h6>
					To hide mini sidebar by default, just add <code>.sidebar-xs</code> and <code>.sidebar-main-hidden</code> classes to <code>&lt;body></code> container.
			    </div>
			    <!-- /info alert -->

...
<body>
	...
	<div class="page-content">
		...
		<!-- Main sidebar -->
		<div class="sidebar sidebar-dark bg-teal sidebar-main sidebar-expand-md">

			<!-- Sidebar mobile toggler -->
			<div class="sidebar-mobile-toggler bg-teal-700 text-center">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Main Custom</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_default_color_custom" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Main custom</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					All sidebars support light and dark color palettes. By default main sidebar is light, if you want to change background color to some custom color from color system, add color helper class to <code>.sidebar-main</code> container and replace <code>.sidebar-light</code> class with <code>.sidebar-dark</code> class.
			    </div>
			    <!-- /info alert -->

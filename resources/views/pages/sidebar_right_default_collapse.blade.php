	...
	<div class="navbar navbar-expand-md navbar-dark bg-indigo navbar-static">
		...
		<div class="collapse navbar-collapse" id="navbar-mobile">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a href="#" class="navbar-nav-link sidebar-control sidebar-right-main-toggle d-none d-md-block" data-popup="tooltip-demo" title="Show - collapse main" data-placement="bottom" data-container="body" data-trigger="hover">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Right, Collapse Main</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_right_default_collapse" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Right, collapse main</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Show right - collapse main</h6>
					Right sidebar has a different purpose - useful for panels with settings, notifications, information etc. It is hidden by default and has various options. To collapse main sidebar when right sidebar is shown, add <code>.sidebar-right-main-toggle</code> class to sidebar control button.
			    </div>
			    <!-- /info alert -->

		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Multiple Navbars</span> - Top Fixed</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_multiple_top_fixed" class="breadcrumb-item">Multiple navbars</a>
							<span class="breadcrumb-item active">Top fixed</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Fixed top navbars</h6>
					You can have maximum of 2 <strong>top</strong> <code>fixed</code> navbars - since the element is removed from the normal document flow and no space is created for the element in the page layout, <code>&lt;body></code> requires additional classes in order to set correct top padding. That's why both navbars need to be wrapped in <code>.fixed-top</code> container and <code>&lt;body></code> container needs to have <code>.navbar-top-[size]-[size]</code> class. See the table below for classes explanation.
			    </div>
			    <!-- /info alert -->

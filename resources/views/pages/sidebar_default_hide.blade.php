...
<body>
	...
	<div class="navbar navbar-expand-md navbar-dark bg-indigo navbar-static">
		...
		<div class="collapse navbar-collapse" id="navbar-mobile">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a href="#" class="navbar-nav-link sidebar-control sidebar-main-hide d-none d-md-block" data-popup="tooltip-demo" title="Hide main" data-placement="bottom" data-container="body" data-trigger="hover">
						<i class="icon-lan3"></i>
					</a>
				</li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Default Hideable</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_default_hide" class="breadcrumb-item">Sidebars</a>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Hideable default sidebar</h6>
					Main sidebar can be completely hidden. To use this option, just change sidebar control button class to <code>.sidebar-main-hide</code> and main sidebar will be hidden/shown on button click.
			    </div>
			    <!-- /info alert -->

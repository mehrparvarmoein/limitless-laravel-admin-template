		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Right, Fix Mini</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_right_mini_toggle" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Right, fix Mini</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Show right - fix mini width</h6>
					This option can be considered as the default one - when right sidebar is shown, main sidebar doesn't change width, whether it's default or mini. Just add <code>.sidebar-right-toggle</code> class to sidebar control button. This option can be also combined with multiple left sidebars.
			    </div>
			    <!-- /info alert -->

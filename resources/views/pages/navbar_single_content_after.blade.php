		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Single Navbar</span> - After Content</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_single_content_after" class="breadcrumb-item">Single navbar</a>
							<span class="breadcrumb-item active">After content</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">After content</h6>
					You can also place bottom navbar <strong>after</strong> page content, if navbar should not overlap sidebar. It is also always sticked to the bottom of the page despite content height. Might be useful for displaying footer navigation.
			    </div>
			    <!-- /info alert -->

		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light border-bottom-0">
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_single_header_after" class="breadcrumb-item">Single navbar</a>
							<span class="breadcrumb-item active">After header</span>
						</div>
				...
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Single Navbar</span> - After Header</h4>
						<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
					</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">After page header content</h6>
					Navbar can be also placed <strong>after</strong> <code>.page-header-content</code> container within <code>.page-header</code>, so that navbar appears as a last component in page header. Useful for toolbar with extra actions.
			    </div>
			    <!-- /info alert -->

			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">User Pages</span> - Tabbed Profile</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="user_pages_profile_tabbed" class="breadcrumb-item">User pages</a>
							...
							<div class="card">
								...
								<div class="card-body p-0">
									<ul class="nav nav-sidebar mb-2">
										...
										<li class="nav-item">
											<a href="login_advanced" class="nav-link" data-toggle="tab">

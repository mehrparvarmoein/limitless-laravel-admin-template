		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item">
								<a href="#" class="navbar-nav-link">
									...
									Merges
									<span class="badge badge-pill bg-warning position-static ml-auto ml-lg-2">5</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="navbar-nav-link">
						...
						<ul class="navbar-nav ml-lg-auto">
							<li class="nav-item">
								<a href="#" class="navbar-nav-link">
									...
									Repositories
									<span class="badge badge-pill bg-grey position-static ml-auto ml-lg-2">28</span>
								</a>
							</li>
						</ul>
					</div>
				...
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Single Navbar</span> - Before Header</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_single_header_before" class="breadcrumb-item">Single navbar</a>
							<span class="breadcrumb-item active">Before header</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Before page header content</h6>
					Navbar can be also placed <strong>before</strong> <code>.page-header-content</code> container within <code>.page-header</code>, so that navbar appears as a first component in page header. Useful for extra navigation (links, tabs, settings etc).
			    </div>
			    <!-- /info alert -->

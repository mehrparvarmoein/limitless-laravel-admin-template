...
<body>
	...
	<!-- Alternative navbar -->
	<div class="navbar navbar-expand-md navbar-dark bg-teal-400 navbar-sticky navbar-static">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Multiple Navbars</span> - Sticky</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_multiple_secondary_sticky" class="breadcrumb-item">Multiple navbars</a>
							<span class="breadcrumb-item active">Sticky</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Sticky secondary navbar</h6>
					Secondary top (bottom) navbar can be also sticked to top (bottom) - this means the navbar toggles between <code>relative</code> and <code>fixed</code>, depending on the scroll position. It is positioned relative until a given offset position is met in the viewport - then it "sticks" in place (like <code>position: fixed;</code>). For cross browser support of sticky element, Limitless template uses <a href="http://leafo.net/sticky-kit/" target="_blank">StickyKit</a> extension. As an alternative, you can also add <code>.sticky-top</code> class to the secondary navbar, which adds <code>position: sticky;</code>, but it's still considered as an experimental feature in some browsers.
			    </div>
			    <!-- /info alert -->

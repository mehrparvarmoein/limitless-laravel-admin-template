		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Horizontal Nav</span> - Disabled Items</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navigation_horizontal_disabled" class="breadcrumb-item">Horizontal nav</a>
							<span class="breadcrumb-item active">Disabled items</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-3">Disabled state of horizontal navbar navigation with dropdown menu is also controlled by JS code located in <code>app.js</code> file - it disables click action in submenu. Styles of all disabled state are defined in SASS and can be easily changed in a set of variables. To disable single item, add <code>.disabled</code> to any <code>.navbar-nav-link</code> element, to disable nested menu levels in dropdown menu - add <code>.disabled</code> class to <code>.dropdown-submenu</code> container. In this case children list of nav items that comes right after nav link won't be toggleable.</p>

						<div class="pb-1">
							<p class="font-weight-semibold">In light navbar:</p>
									...
									<ul class="navbar-nav">
										...
										<li class="nav-item dropdown">
											<a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
												<i class="icon-cube3 mr-2 ml-xl-0"></i>
												Disabled levels
											</a>
											...
											<div class="dropdown-menu">
												...
												<a href="#" class="dropdown-item disabled"><i class="icon-chrome"></i> Second level</a>
											</div>
										</li>
									</ul>
									...
									<ul class="navbar-nav ml-xl-auto">
										<li class="nav-item dropdown">
											<a href="#" class="navbar-nav-link dropdown-toggle disabled" data-toggle="dropdown">
												...
												<span class="d-xl-none ml-2">Disabled icon</span>
											</a>
										...
										<li class="nav-item dropdown">
											<a href="#" class="navbar-nav-link dropdown-toggle caret-0 disabled" data-toggle="dropdown">
												<i class="icon-bell2"></i>
												<span class="d-xl-none ml-2">With badge</span>
										...
										<li class="nav-item dropdown dropdown-user">
											<a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle disabled" data-toggle="dropdown">
						...
						<p class="font-weight-semibold">In dark navbar:</p>

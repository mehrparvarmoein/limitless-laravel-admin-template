			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Content Sidebar</span> - Right</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_content_right" class="breadcrumb-item">Content sidebar</a>
							<span class="breadcrumb-item active">Right</span>
						</div>
				...
				<div class="d-flex align-items-start flex-column flex-md-row">
					...
					<div class="order-2 order-md-1">
						...
						<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
							...
							Fot the right content sidebar, inner container classes need to be used without breakpoints, because since sidebar markup comes after content, we need to change content ordering. <code>.flex-column</code> and <code>.flex-[breakpoint]-row</code> classes are also required.
					    </div>
					    <!-- /info alert -->

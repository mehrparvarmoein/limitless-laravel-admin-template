...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/colors_brown.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Brown Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_brown" class="breadcrumb-item">Colors</a>
							<span class="breadcrumb-item active">Brown palette</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-brown-800 demo-color"><span>brown-800</span></div>

							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Brown 800</strong>
										<div class="text-muted mt-1">#4E342E</div>
									</div>

									<div class="list-icons">
				                		<a href="#brown_800" class="list-icons-item" data-toggle="modal">
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-brown-700 demo-color"><span>brown-700</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Brown 700</strong>
										<div class="text-muted mt-1">#5D4037</div>
									</div>

									<div class="list-icons">
				                		<a href="#brown_700" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-brown-600 demo-color"><span>brown-600</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Brown 600</strong>
										<div class="text-muted mt-1">#6D4C41</div>
									</div>

									<div class="list-icons">
				                		<a href="#brown_600" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-brown demo-color"><span>brown</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Brown 500</strong>
										<div class="text-muted mt-1">#795548</div>
									</div>

									<div class="list-icons">
				                		<a href="#brown_500" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-brown-400 demo-color"><span>brown-400</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Brown 400</strong>
										<div class="text-muted mt-1">#8D6E63</div>
									</div>

									<div class="list-icons">
				                		<a href="#brown_400" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-brown-300 demo-color"><span>brown-300</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Brown 300</strong>
										<div class="text-muted mt-1">#A1887F</div>
									</div>

									<div class="list-icons">
				                		<a href="#brown_300" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
				...
				<div class="card">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td><code>.bg-brown</code><br><code>.bg-brown-*</code></td>
									<td>Classes for background color. You can choose between 1 brown color using <code>.bg-brown</code> class and 5 accent colors using <code>.bg-brown-*</code> class in 300, 400, 600, 700, 800 range</td>
								</tr>
								<tr>
									<td><code>.border-brown</code><br><code>.border-brown-*</code></td>
				...
				<div class="mb-3">
					...
					<!-- Basic alert -->
					<div class="alert alpha-brown border-brown text-brown-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						Here you can see how brown palette can be used with different components. By the way, this alert uses it as well
				    </div>
				    <!-- /basic alert -->


				    <!-- White alert -->
					<div class="alert bg-white border-brown text-brown-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						And this alert uses brown color palette, but white background color. With utility classes, everything is possible
				    </div>
				    <!-- /white alert -->


				    <!-- Solid alert -->
				    <div class="alert bg-brown alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown">
							<div class="text-center">
								<h6 class="m-0 font-weight-semibold">Input field text</h6>
								<p class="mb-3 text-muted">Using <code>.text-brown</code> classes</p>
							</div>

							<input type="text" class="form-control text-brown text-uppercase font-weight-semibold font-size-sm line-height-sm" value="Input field text">
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown">
							...
							<div class="form-group-feedback form-group-feedback-right">
								...
								<div class="form-control-feedback text-brown">
									<i class="icon-help"></i>
								</div>
							</div>
						</div>
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-brown">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-brown"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-brown"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-brown btn-icon" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.bg-brown</code> classes</p>
							</div>
							...
							<div class="input-group">
								...
								<span class="input-group-append">
									<button class="btn bg-brown" type="button">Button</button>
								</span>									
							</div>
						</div>
			    	</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="brown-radio" checked data-fouc>
										Selected
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="brown-radio" data-fouc>
										Unselected
									</label>
								</div>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown">
							...
							<select class="form-control form-control-select2" data-container-css-class="text-brown" data-fouc>
			    ...
			    <div class="row">
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-solid bg-brown rounded-top border-0 mb-0">
								...
								<div class="tab-content card card-body rounded-top-0 mb-0">
									<div class="tab-pane fade active show" id="colored-nav-tab1">
										Add <code>custom</code> background color to the tab navigation with <code>.bg-brown</code> palette classes
									</div>
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-brown rounded-top-0 border-top-1 mb-0">
									<div class="tab-pane fade active show" id="colored-tab1">
										Add <code>custom</code> background color to the tabs navigation and content with <code>.bg-brown</code> palette classes
									</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<span class="text-brown">Brown text</span> and <a href="#" class="text-brown">brown link</a>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<span class="badge bg-brown">Brown badge</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<span class="badge bg-brown badge-pill">390</span>
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div class="progress">
								<div class="progress-bar bg-brown" style="width: 55%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped bg-brown" style="width: 65%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped progress-bar-animated bg-brown" style="width: 75%">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th>#</th>
											<th class="alpha-brown">First Name</th>
											<th>Last Name</th>
											<th class="bg-brown">Username</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td>1</td>
											<td class="alpha-brown">Eugene</td>
											<td>Kopyov</td>
											<td class="bg-brown">@Kopyov</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="alpha-brown">Victoria</td>
											<td>Baker</td>
											<td class="bg-brown">@Vicky</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="alpha-brown">James</td>
											<td>Alexander</td>
											<td class="bg-brown">@Alex</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button type="button" class="btn bg-brown"><i class="icon-menu7 mr-2"></i> Button</button>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button type="button" class="btn bg-brown btn-labeled btn-labeled-left">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button type="button" class="btn btn-outline bg-brown text-brown border-brown">
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card">
							<div class="card-header bg-brown header-elements-inline">
								<h6 class="card-title">Brown card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Brown card using <code>.bg-brown</code> class added to the card header
							</div>
						</div>
			    	</div>

			    	<div class="col-md-4">
			    		<div class="card border-1 border-brown">
							<div class="card-header header-elements-inline bg-brown">
								<h6 class="card-title">Brown bordered card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Bordered brown card using <code>.bg-brown</code> and <code>.border-brown</code> classes
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card bg-brown">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Brown solid card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Solid brown card using <code>.bg-brown</code> class added to the card container
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button type="button" class="btn bg-brown" data-popup="tooltip-custom" title="Brown tooltip" data-placement="bottom" data-container="body">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button type="button" class="btn bg-brown" data-popup="popover-custom" title="Brown popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover title
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button type="button" class="btn bg-brown" data-popup="popover-solid" title="Brown popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover background
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button type="button" class="btn bg-brown" data-toggle="modal" data-target="#modal_brown_header">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button type="button" class="btn bg-brown" data-toggle="modal" data-target="#modal_brown">
									<i class="icon-bubbles8 mr-2"></i>
									Modal background
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button type="button" class="btn bg-brown" data-toggle="modal" data-target="#modal_brown_footer">
									<i class="icon-bubbles8 mr-2"></i>
									Modal dialog footer
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<p class="mb-3 text-muted">Using <code>.bg-brown</code> color classes</p>

							<div>
								<button class="btn bg-brown noty-launch">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button class="btn bg-brown growl-launch">
									<i class="icon-bubbles6 mr-2"></i>
									jGrowl notification
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown text-center">
							...
							<div>
								<button class="btn bg-brown pnotify-launch">
									<i class="icon-bubbles6 mr-2"></i>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-brown</code> color classes</p>
							</div>

							<div class="dropdown-menu border-brown border-2" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-brown">
							...
							<div class="dropdown-menu bg-brown border-brown" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item"><i class="icon-menu7"></i> Action</a>
								<a href="#" class="dropdown-item"><i class="icon-screen-full"></i> Another action</a>
								<a href="#" class="dropdown-item"><i class="icon-mail5"></i> Something else here</a>
								<div class="dropdown-divider"></div>
			    		...
			    		<div class="card card-body border-top-brown">
							...
							<div class="dropdown-menu bg-brown border-brown" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item">
									<i class="icon-menu7"></i>
									Action
									<span class="badge bg-brown-800 ml-auto">Badge</span>
								</a>
								<a href="#" class="dropdown-item">
									<i class="icon-screen-full"></i>
									Another action
									<span class="badge badge-pill bg-brown-800 ml-auto">98</span>
								</a>
								<div class="dropdown-divider"></div>
				...
				<!-- Modal header -->
				<div id="modal_brown_header" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-brown">
								<h6 class="modal-title">Brown header</h6>
				...
				<!-- Solid modal -->
				<div id="modal_brown" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content bg-brown">
							<div class="modal-header">
								<h6 class="modal-title">Brown background</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
				...
				<!-- Modal footer -->
				<div id="modal_brown_footer" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h6 class="modal-title">Brown footer</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
	            ...
	            <!-- Brown 800 -->
				<div id="brown_800" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										...
										<td><code>.bg-brown-800</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-brown-800</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-brown-800</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-brown-800</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-brown-800</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-brown-800</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Brown 700 -->
				<div id="brown_700" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-brown-700</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-brown-700</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-brown-700</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-brown-700</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-brown-700</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-brown-700</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Brown 600 -->
				<div id="brown_600" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-brown-600</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-brown-600</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-brown-600</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-brown-600</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-brown-600</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-brown-600</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Brown 500 -->
				<div id="brown_500" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-brown</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-brown</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-brown</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-brown</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-brown</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-brown</code></td>
									</tr>
									<tr>
										<td>Alpha color:</td>
										<td><code>.alpha-brown</code></td>
	            ...
	            <!-- Brown 400 -->
				<div id="brown_400" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-brown-400</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-brown-400</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-brown-400</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-brown-400</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-brown-400</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-brown-400</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Brown 300 -->
				<div id="brown_300" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-brown-300</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-brown-300</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-brown-300</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-brown-300</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-brown-300</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-brown-300</code></td>
									</tr>
								</table>
							</div>

...
<body>
	...
	<div class="navbar navbar-expand-md navbar-dark bg-indigo navbar-static">
		<div class="navbar-brand">
			<a href="../full/index" class="d-inline-block">
		...
		<div class="collapse navbar-collapse" id="navbar-mobile">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a href="../full/index" class="navbar-nav-link">
				...
				<li class="nav-item mega-menu-full">
					<a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">Horizontal</a>

					<div class="dropdown-menu dropdown-content">
						<div class="dropdown-content-body">
							<div class="row">
								<div class="col-xl-3">
									<div class="font-size-sm line-height-sm font-weight-semibold text-uppercase mt-1">Column 1 title</div>
									<div class="dropdown-divider mb-2"></div>
									<div class="mb-3 mb-xl-0">
										<a href="#" class="dropdown-item rounded">Link 1, column 1</a>
										<a href="#" class="dropdown-item rounded">Link 2, column 1</a>
										<a href="#" class="dropdown-item rounded">Link 3, column 1</a>
										<a href="#" class="dropdown-item rounded">Link 4, column 1</a>
									</div>
								</div>
								<div class="col-xl-3">
									<div class="font-size-sm line-height-sm font-weight-semibold text-uppercase mt-1">Column 2 title</div>
									<div class="dropdown-divider mb-2"></div>
									<div class="mb-3 mb-xl-0">
										<a href="#" class="dropdown-item rounded">Link 1, column 2</a>
										<a href="#" class="dropdown-item rounded">Link 2, column 2</a>
										<a href="#" class="dropdown-item rounded">Link 3, column 2</a>
										<a href="#" class="dropdown-item rounded">Link 4, column 2</a>
									</div>
								</div>
								<div class="col-xl-3">
									<div class="font-size-sm line-height-sm font-weight-semibold text-uppercase mt-1">Column 3 title</div>
									<div class="dropdown-divider mb-2"></div>
									<div class="mb-3 mb-xl-0">
										<a href="#" class="dropdown-item rounded">Link 1, column 3</a>
										<a href="#" class="dropdown-item rounded">Link 2, column 3</a>
										<a href="#" class="dropdown-item rounded">Link 3, column 3</a>
										<a href="#" class="dropdown-item rounded">Link 4, column 3</a>
									</div>
								</div>
								<div class="col-xl-3">
									<div class="font-size-sm line-height-sm font-weight-semibold text-uppercase mt-1">Column 4 title</div>
									<div class="dropdown-divider mb-2"></div>
									<div class="mb-3 mb-xl-0">
										<a href="#" class="dropdown-item rounded">Link 1, column 4</a>
										<a href="#" class="dropdown-item rounded">Link 2, column 4</a>
										<a href="#" class="dropdown-item rounded">Link 3, column 4</a>
										<a href="#" class="dropdown-item rounded">Link 4, column 4</a>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Starters</span> - Horizontal Nav</h4>

...
<head>
	...
	<!-- Page JS files -->
	<script src="../../../../global_assets/js/plugins/buttons/hover_dropdown.min.js"></script>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Horizontal Nav</span> - On Hover</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navigation_horizontal_hover" class="breadcrumb-item">Horizontal nav</a>
							<span class="breadcrumb-item active">On hover</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Open menu on hover</h5>
					...
					<div class="card-body">
						...
						<div class="pb-1">
							<p class="font-weight-semibold">Light navbar menus:</p>
								...
								<div class="navbar-collapse collapse" id="navbar-demo-light">
									...
									<ul class="navbar-nav ml-xl-auto">
										...
										<li class="nav-item dropdown dropdown-user">
											<a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
						...
						<p class="font-weight-semibold">Dark navbar menus:</p>
						<div class="navbar navbar-expand-xl navbar-dark bg-indigo-400 navbar-component rounded mb-0">
							<div class="navbar-brand">
								<a href="index" class="d-inline-block">

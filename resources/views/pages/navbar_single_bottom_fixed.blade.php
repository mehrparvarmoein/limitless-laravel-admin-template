		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Single Navbar</span> - Bottom Fixed</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_single_bottom_fixed" class="breadcrumb-item">Single navbar</a>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Fixed bottom navbar</h6>
					Bottom <code>fixed</code> navbar is positioned relative to the screen's viewport and doesn't move when scrolled. To use, add <code>.fixed-bottom</code> class to the <code>.navbar</code> container and <code>.navbar-bottom</code> class to the <code>&lt;body></code> container.
			    </div>
			    <!-- /info alert -->

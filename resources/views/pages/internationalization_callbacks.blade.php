...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/internationalization_callbacks.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Translation</span> - Callbacks</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="internationalization_callbacks" class="breadcrumb-item">Translation</a>
							<span class="breadcrumb-item active">Callbacks</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Translation callbacks</h5>
...
// or use callback function instead
i18next.on('initialized', function() {
	[...]
});

// Do stuff when language has been changed

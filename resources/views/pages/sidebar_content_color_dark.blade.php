			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Content Sidebar</span> - Dark Color</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_content_color_dark" class="breadcrumb-item">Content sidebar</a>
							<span class="breadcrumb-item active">Dark color</span>
						</div>
				...
				<div class="d-flex align-items-start flex-column flex-md-row">
					...
					<div class="order-2 order-md-1">
						...
						<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
							...
							<h6 class="alert-heading font-weight-semibold mb-1">Dark badkground color</h6>
							All sidebars support light and dark color palettes. By default content sidebar is light, if you want to change background color to dark, simply replace <code>.sidebar-light</code> class with <code>.sidebar-dark</code> class in <code>.sidebar-component</code> container.
					    </div>
					    <!-- /info alert -->
...
&lt;!-- /mini sidebar layout -->
					...
					<div class="sidebar sidebar-dark sidebar-component sidebar-component-right order-1 order-md-2 sidebar-expand-md">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row row-tile no-gutters">
										<div class="col-6">
											<button type="button" class="btn bg-slate-800 border-light-alpha btn-block btn-float border-top-0 border-left-0 m-0">
												<i class="icon-github4 icon-2x"></i>
												<span>Github</span>
											</button>

											<button type="button" class="btn bg-slate-800 border-light-alpha btn-block btn-float m-0 border-bottom-0 border-left-0">
												<i class="icon-dropbox text-blue-400 icon-2x"></i>
												<span>Dropbox</span>
											</button>
										</div>
										...
										<div class="col-6">
											<button type="button" class="btn bg-slate-800 border-light-alpha btn-block btn-float m-0 border-top-0 border-right-0">
												<i class="icon-dribbble3 text-pink-400 icon-2x"></i>
												<span>Dribbble</span>
											</button>

											<button type="button" class="btn bg-slate-800 border-light-alpha btn-block btn-float m-0 border-bottom-0 border-right-0">
												<i class="icon-google-drive text-success-400 icon-2x"></i>
									...
									<ul class="nav nav-sidebar" data-nav-type="accordion">
										...
										<li class="nav-item">
											<a href="#" class="nav-link">
												...
												Assigned to me
												<span class="badge bg-slate-600 badge-pill ml-auto">86</span>
											</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link">
												...
												Assigned to my team
												<span class="badge bg-slate-600 badge-pill ml-auto">47</span>
											</a>
										</li>
										<li class="nav-item">
									...
									<ul class="media-list">
										<li class="media">
											<a href="#" class="mr-3 position-relative">
												<img src="../../../../global_assets/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
												<span class="badge bg-success-400 badge-pill badge-float">6</span>
											</a>
										...
										<li class="media">
											<a href="#" class="mr-3 position-relative">
												<img src="../../../../global_assets/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
												<span class="badge bg-success-400 badge-pill badge-float">9</span>
											</a>

			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Vertical Nav</span> - Icons Alignment</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navigation_vertical_right_icons" class="breadcrumb-item">Vertical nav</a>
							<span class="breadcrumb-item active">Icons alignment</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Icons alignment</h5>
					...
					<div class="card-body">
						<p class="mb-3">Vertical navigation can have 3 options: <strong>no-icons</strong> - boring list with horizontal spacing in all levels; <strong>left icons</strong> - since we read from left-to-right (right-to-left for RTL folks), this is the default option as we understand visual stuff faster than we read text; <strong>right icons</strong> - if icons are not that important, but you still want to show them in less notable mode, this option might be useful. To reverse icons alignment, add <code>.nav-sidebar-icons-reverse</code> class to main sidebar nav container.</p>

						<div class="row">
							<div class="col-md-6">
								<p class="font-weight-semibold">Left aligned icons:</p>
							...
							<div class="col-md-6">
								<p class="font-weight-semibold">Right aligned icons:</p>
								<div class="sidebar sidebar-light sidebar-component position-static w-100 d-block">
									<div class="sidebar-content position-static">

...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/charts/google/bubbles/bubble.js"></script>
	<script src="../../../../global_assets/js/demo_pages/charts/google/bubbles/bubble_gradient.js"></script>
	<script src="../../../../global_assets/js/demo_pages/charts/google/scatter/scatter.js"></script>
	<script src="../../../../global_assets/js/demo_pages/charts/google/scatter/scatter_diff.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Google</span> - Scatter &amp; Bubbles</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="google_scatter_bubble" class="breadcrumb-item">Google</a>
							<span class="breadcrumb-item active">Scatter &amp; bubbles</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Bubble charts</h5>
					...
					<div class="card-body">
						<div class="mb-3">
							<h6 class="font-weight-semibold">Simple bubble chart</h6>
						...
						<div class="mb-3">
							<h6 class="font-weight-semibold">Color by numbers</h6>
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Scatter charts</h5>
						<div class="header-elements">
							<div class="list-icons">
		                		<a class="list-icons-item" data-action="collapse"></a>
		                		<a class="list-icons-item" data-action="reload"></a>
					...
					<div class="card-body">
						...
						<div class="mb-3">
							<h6 class="font-weight-semibold">Diff scatter chart</h6>

		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Right Dark</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_right_color_dark" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Right dark</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Dark background color</h6>
					All sidebars support light and dark color palettes. By default dark sidebar is light, if you want to change background color to dark, simply replace <code>.sidebar-light</code> class with <code>.sidebar-dark</code> class in <code>.sidebar-dark</code> container.
			    </div>
			    <!-- /info alert -->

			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Vertical Nav</span> - Badges</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navigation_vertical_badges" class="breadcrumb-item">Vertical nav</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Nav item badges</h5>
					...
					<div class="card-body">
						...
						<div class="row">
											...
											<ul class="nav nav-sidebar" data-nav-type="accordion">
												...
												<li class="nav-item">
													<a href="#" class="nav-link">
														...
														Active link
														<span class="badge bg-teal-800 ml-auto">New</span>
													</a>
												</li>
												...
												<li class="nav-item nav-item-submenu">
													<a href="#" class="nav-link">
														...
														With children
														<span class="badge bg-transparent ml-auto">Pending</span>
													</a>
													...
													<ul class="nav nav-group-sub">
														<li class="nav-item">
															<a href="#" class="nav-link">
																Second level link
																<span class="badge bg-success ml-auto">Done</span>
															</a>
														</li>
												...
												<li class="nav-item nav-item-submenu">
													<a href="#" class="nav-link">
														...
														Multiple levels
														<span class="badge bg-blue ml-auto">40</span>
													</a>
													...
													<ul class="nav nav-group-sub">
														...
														<li class="nav-item nav-item-submenu">
															<a href="#" class="nav-link">
																...
																<span class="badge bg-danger-400 ml-auto">Bug</span>
															</a>
															<ul class="nav nav-group-sub">
																<li class="nav-item">
																	<a href="#" class="nav-link">
																		Third level
																		<span class="badge badge-pill bg-purple-300 ml-auto">39</span>
																	</a>
																</li>
												...
												<li class="nav-item nav-item-submenu">
													<a href="#" class="nav-link disabled">
														...
														Disabled levels
														<span class="badge bg-slate ml-auto">Fixed</span>
													</a>
							...
							<div class="col-md-6">
								...
								<div class="sidebar sidebar-dark sidebar-component position-static w-100 d-block mb-md-4">
									<div class="sidebar-content position-static">
											...
											<ul class="nav nav-sidebar" data-nav-type="accordion">
												...
												<li class="nav-item nav-item-submenu">
													...
													<ul class="nav nav-group-sub">
														<li class="nav-item">
															<a href="#" class="nav-link">
																Second level link
																<span class="badge bg-white text-default ml-auto">Done</span>
															</a>
														</li>
														<li class="nav-item"><a href="#" class="nav-link">Second level link</a></li>
													</ul>
														...
														<li class="nav-item nav-item-submenu">
															...
															<ul class="nav nav-group-sub">
																<li class="nav-item">
																	<a href="#" class="nav-link">
																		Third level
																		<span class="badge badge-pill bg-white text-default ml-auto">39</span>
																	</a>
																</li>
																<li class="nav-item"><a href="#" class="nav-link">Third level</a></li>
															</ul>
												...
												<li class="nav-item nav-item-submenu">
													<a href="#" class="nav-link disabled">
														<i class="icon-make-group"></i>
														Disabled levels
														<span class="badge bg-success ml-auto">Fixed</span>
													</a>

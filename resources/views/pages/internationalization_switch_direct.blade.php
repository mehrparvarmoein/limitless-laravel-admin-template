...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/internationalization_switch_direct.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Translation</span> - Direct Switch</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="internationalization_switch_direct" class="breadcrumb-item">Translation</a>

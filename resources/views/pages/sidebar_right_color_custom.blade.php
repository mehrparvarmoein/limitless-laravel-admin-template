		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Right Custom</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_right_color_custom" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Right custom</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Custom background color</h6>
					All sidebars support light and dark color palettes. By default right sidebar is light, if you want to change background color to some custom color from color system, add color helper class to <code>.sidebar-right</code> container and replace <code>.sidebar-light</code> class with <code>.sidebar-dark</code> class.
			    </div>
			    <!-- /info alert -->
...
&lt;!-- /mini sidebar layout -->
		...
		<!-- Right sidebar -->
		<div class="sidebar sidebar-dark bg-indigo-400 sidebar-right sidebar-expand-md">

			<!-- Sidebar mobile toggler -->
			<div class="sidebar-mobile-toggler bg-indigo text-center">
					...
					<div class="card-body">
						<form action="#">
							<div class="form-group-feedback form-group-feedback-right">
								<input type="search" class="form-control text-white" placeholder="Search">
								<div class="form-control-feedback text-white">
									<i class="icon-search4 font-size-base opacity-50"></i>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="row row-tile no-gutters">
							<div class="col-6">
								<button type="button" class="btn bg-indigo-600 border-light-alpha btn-block btn-float border-top-0 border-left-0 m-0">
									<i class="icon-github4 icon-2x"></i>
									<span>Github</span>
								</button>

								<button type="button" class="btn bg-indigo-600 border-light-alpha btn-block btn-float m-0 border-bottom-0 border-left-0">
									<i class="icon-dropbox text-blue-400 icon-2x"></i>
									<span>Dropbox</span>
								</button>
							</div>
							...
							<div class="col-6">
								<button type="button" class="btn bg-indigo-600 border-light-alpha btn-block btn-float m-0 border-top-0 border-right-0">
									<i class="icon-dribbble3 text-pink-400 icon-2x"></i>
									<span>Dribbble</span>
								</button>

								<button type="button" class="btn bg-indigo-600 border-light-alpha btn-block btn-float m-0 border-bottom-0 border-right-0">
									<i class="icon-google-drive text-success-400 icon-2x"></i>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="#" class="nav-link">
								...
								Assign users
								<span class="badge bg-transparent badge-pill ml-auto">94 online</span>
							</a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a href="#" class="nav-link">
								...
								Active tasks
								<span class="badge bg-white text-default badge-pill ml-auto">28</span>
							</a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a href="#" class="nav-link">
								...
								Assigned to me
								<span class="badge bg-indigo-800 badge-pill ml-auto">86</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="#" class="nav-link">
								...
								Assigned to my team
								<span class="badge bg-indigo-800 badge-pill ml-auto">47</span>
							</a>
						</li>
						<li class="nav-item">
						...
						<ul class="media-list">
							<li class="media">
								...
								<div class="media-body">
									...
									<span class="font-size-xs opacity-75 d-block">Santa Ana, CA.</span>
								</div>
								<div class="ml-3 align-self-center">
									<span class="badge badge-mark bg-teal-300 border-teal-300"></span>
								</div>
							</li>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="media-title text-white font-weight-semibold">Jeremy Victorino</a>
									<span class="font-size-xs opacity-75 d-block">Dowagiac, MI.</span>
								</div>
								<div class="ml-3 align-self-center">
									<span class="badge badge-mark bg-danger-300 border-danger-300"></span>
								</div>
							</li>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="media-title text-white font-weight-semibold">Margo Baker</a>
									<span class="font-size-xs opacity-75 d-block">Kasaan, AK.</span>
								</div>
								<div class="ml-3 align-self-center">
									<span class="badge badge-mark bg-success-300 border-success-300"></span>
								</div>
							</li>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="media-title text-white font-weight-semibold">Beatrix Diaz</a>
									<span class="font-size-xs opacity-75 d-block">Neenah, WI.</span>
								</div>
								<div class="ml-3 align-self-center">
									<span class="badge badge-mark bg-warning-300 border-warning-300"></span>
								</div>
							</li>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="media-title text-white font-weight-semibold">Richard Vango</a>
									<span class="font-size-xs opacity-75 d-block">Grapevine, TX.</span>
								</div>
								<div class="ml-3 align-self-center">
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="media-list">
							<li class="media">
								<div class="mr-3">
									<a href="#" class="btn bg-transparent border-white text-white rounded-round border-2 btn-icon">
										<i class="icon-git-pull-request"></i>
									</a>
								</div>

								<div class="media-body">
									Drop the IE <a href="#" class="text-white">specific hacks</a> for temporal inputs
									<div class="font-size-sm opacity-75">4 minutes ago</div>
								</div>
							</li>
							...
							<li class="media">
								...
								<div class="media-body">
									Add full font overrides for popovers and tooltips
									<div class="font-size-sm opacity-75">36 minutes ago</div>
								</div>
							</li>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="text-white">Chris Arney</a> created a new <span class="font-weight-semibold">Design</span> branch
									<div class="font-size-sm opacity-75">2 hours ago</div>
								</div>
							</li>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="text-white">Eugene Kopyov</a> merged <span class="font-weight-semibold">Master</span> and <span class="font-weight-semibold">Dev</span> branches
									<div class="font-size-sm opacity-75">Dec 18, 18:36</div>
								</div>
							</li>
							...
							<li class="media">
								...
								<div class="media-body">
									Have Carousel ignore keyboard events
									<div class="font-size-sm opacity-75">Dec 12, 05:46</div>
								</div>
							</li>
						</ul>
					</div>
					...
					<div class="card-body">
						<form action="#">
							<div class="form-group">
								<div class="form-check form-check-right form-check-light">
						...
						<ul class="media-list">
							<li class="media">
								<a href="#" class="mr-3 position-relative">
									<img src="../../../../global_assets/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
									<span class="badge bg-white badge-pill badge-float text-default">6</span>
								</a>
								...
								<div class="ml-3 align-self-center">
									<div class="dropdown">
										<a href="#" class="text-white dropdown-toggle caret-0" data-toggle="dropdown"><i class="icon-more2"></i></a>
										<div class="dropdown-menu dropdown-menu-right">
							...
							<li class="media">
								<a href="#" class="mr-3 position-relative">
									<img src="../../../../global_assets/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
									<span class="badge bg-white badge-pill badge-float text-default">9</span>
								</a>

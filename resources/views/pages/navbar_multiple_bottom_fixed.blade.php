...
<body class="navbar-md-md-bottom">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Multiple Navbars</span> - Bottom Fixed</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_multiple_bottom_fixed" class="breadcrumb-item">Multiple navbars</a>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Fixed bottom navbars</h6>
					You can have maximum of 2 <strong>bottom</strong> <code>fixed</code> navbars - since the element is removed from the normal document flow and no space is created for the element in the page layout, <code>&lt;body></code> requires additional classes in order to set correct bottom padding. That's why both navbars need to be wrapped in <code>.fixed-bottom</code> container and <code>&lt;body></code> container needs to have <code>.navbar-bottom-[size]-[size]</code> class. See the table below for classes explanation.
			    </div>
			    <!-- /info alert -->
...
&lt;!-- /document body -->
	...
	<div class="fixed-bottom">
		...
		<!-- Alternative navbar -->
		<div class="navbar navbar-expand-md navbar-dark bg-teal-400 border-transparent">
		...
		<div class="navbar navbar-expand-md navbar-light">
			...
			<div class="navbar-collapse collapse" id="navbar-third">
				...
				<ul class="navbar-nav ml-md-auto">
					...
					<li class="nav-item dropup">
						<a href="#" class="navbar-nav-link dropdown-toggle caret-0" data-toggle="dropdown">
							<i class="icon-share4 d-none d-md-inline-block"></i>

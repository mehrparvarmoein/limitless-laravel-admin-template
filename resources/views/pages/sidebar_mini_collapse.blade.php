		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Mini Collapsible</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_mini_collapse" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Mini collapsible</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Collapsible mini sidebar</h6>
					To make main sidebar collapsed by default, add <code>.sidebar-xs</code> class to <code>&lt;body></code> container. Use the same <code>.sidebar-main-toggle</code> sidebar control button class to expand it.
			    </div>
			    <!-- /info alert -->

			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Content Sidebar</span> - Custom Sections Color</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_content_color_sections_custom" class="breadcrumb-item">Content sidebar</a>
							<span class="breadcrumb-item active">Custom sections color</span>
						</div>
				...
				<div class="d-flex align-items-start flex-column flex-md-row">
					...
					<div class="order-2 order-md-1">
						...
						<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
							...
							<h6 class="alert-heading font-weight-semibold mb-1">Custom sidebar sections color</h6>
							Since all sections are based on card component, you can easily use all color options available for cards - simply add <code>.bg-*</code> color helper classes to <code>.card</code> container and adjust inner content colors with text or background colors.
					    </div>
					    <!-- /info alert -->
							...
							<div class="card bg-indigo-400">
								...
								<div class="card-body">
									<div class="row row-tile no-gutters">
										<div class="col-6">
											<button type="button" class="btn bg-indigo border-light-alpha btn-block btn-float border-top-0 border-left-0 m-0">
												<i class="icon-github4 icon-2x"></i>
												<span>Github</span>
											</button>

											<button type="button" class="btn bg-indigo border-light-alpha btn-block btn-float m-0 border-bottom-0 border-left-0">
												<i class="icon-dropbox text-blue-400 icon-2x"></i>
												<span>Dropbox</span>
											</button>
										</div>
										...
										<div class="col-6">
											<button type="button" class="btn bg-indigo border-light-alpha btn-block btn-float m-0 border-top-0 border-right-0">
												<i class="icon-dribbble3 text-pink-300 icon-2x"></i>
												<span>Dribbble</span>
											</button>

											<button type="button" class="btn bg-indigo border-light-alpha btn-block btn-float m-0 border-bottom-0 border-right-0">
												<i class="icon-google-drive text-success-400 icon-2x"></i>
								...
								<ul class="nav nav-sidebar" data-nav-type="accordion">
									...
									<li class="nav-item">
										<a href="#" class="nav-link">
											...
											Assigned to me
											<span class="badge bg-brown-800 badge-pill ml-auto">86</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="#" class="nav-link">
											...
											Assigned to my team
											<span class="badge bg-brown-800 badge-pill ml-auto">47</span>
										</a>
									</li>
									<li class="nav-item">
									...
									<ul class="media-list">
										<li class="media">
											<a href="#" class="mr-3 position-relative">
												<img src="../../../../global_assets/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
												<span class="badge bg-success-400 border-2 border-grey-700 badge-pill badge-float">6</span>
											</a>
										...
										<li class="media">
											<a href="#" class="mr-3 position-relative">
												<img src="../../../../global_assets/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
												<span class="badge bg-success-400 border-2 border-grey-700 badge-pill badge-float">9</span>
											</a>

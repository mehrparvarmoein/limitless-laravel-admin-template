			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Content Sidebar</span> - Right Stretched</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_content_right_stretch" class="breadcrumb-item">Content sidebar</a>
							<span class="breadcrumb-item active">Right stretched</span>
						</div>
				...
				<div class="d-flex flex-column flex-md-row">
					...
					<div class="order-2 order-md-1">
						...
						<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
							...
							<h6 class="alert-heading font-weight-semibold mb-1">Stretched sidebar</h6>
							This is the default behaviour of content sidebar - flexbox forces content sidebar to fill all available space below. Inner container doesn't require any additional flex utility classes.
					    </div>
					    <!-- /info alert -->

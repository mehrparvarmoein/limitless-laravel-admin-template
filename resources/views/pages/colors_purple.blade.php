...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/colors_purple.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Purple Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_purple" class="breadcrumb-item">Colors</a>
							<span class="breadcrumb-item active">Purple palette</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-purple-800 demo-color"><span>purple-800</span></div>

							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Purple 800</strong>
										<div class="text-muted mt-1">#4527A0</div>
									</div>

									<div class="list-icons">
				                		<a href="#purple_800" class="list-icons-item" data-toggle="modal">
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-purple-700 demo-color"><span>purple-700</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Purple 700</strong>
										<div class="text-muted mt-1">#512DA8</div>
									</div>

									<div class="list-icons">
				                		<a href="#purple_700" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-purple-600 demo-color"><span>purple-600</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Purple 600</strong>
										<div class="text-muted mt-1">#5E35B1</div>
									</div>

									<div class="list-icons">
				                		<a href="#purple_600" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-purple demo-color"><span>purple</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Purple 500</strong>
										<div class="text-muted mt-1">#673AB7</div>
									</div>

									<div class="list-icons">
				                		<a href="#purple_500" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-purple-400 demo-color"><span>purple-400</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Purple 400</strong>
										<div class="text-muted mt-1">#7E57C2</div>
									</div>

									<div class="list-icons">
				                		<a href="#purple_400" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-purple-300 demo-color"><span>purple-300</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Purple 300</strong>
										<div class="text-muted mt-1">#9575CD</div>
									</div>

									<div class="list-icons">
				                		<a href="#purple_300" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
				...
				<div class="card">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td><code>.bg-purple</code><br><code>.bg-purple-*</code></td>
									<td>Classes for background color. You can choose between 1 purple color using <code>.bg-purple</code> class and 5 accent colors using <code>.bg-purple-*</code> class in 300, 400, 600, 700, 800 range</td>
								</tr>
								<tr>
									<td><code>.border-purple</code><br><code>.border-purple-*</code></td>
				...
				<div class="mb-3">
					...
					<!-- Basic alert -->
					<div class="alert alpha-purple border-purple text-purple-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						Here you can see how purple palette can be used with different components. By the way, this alert uses it as well
				    </div>
				    <!-- /basic alert -->


				    <!-- White alert -->
					<div class="alert bg-white border-purple text-purple-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						And this alert uses purple color palette, but white background color. With utility classes, everything is possible
				    </div>
				    <!-- /white alert -->


				    <!-- Solid alert -->
				    <div class="alert bg-purple alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple">
							<div class="text-center">
								<h6 class="m-0 font-weight-semibold">Input field text</h6>
								<p class="mb-3 text-muted">Using <code>.text-purple</code> classes</p>
							</div>

							<input type="text" class="form-control text-purple text-uppercase font-weight-semibold font-size-sm line-height-sm" value="Input field text">
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple">
							...
							<div class="form-group-feedback form-group-feedback-right">
								...
								<div class="form-control-feedback text-purple">
									<i class="icon-help"></i>
								</div>
							</div>
						</div>
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-purple">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-purple"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-purple"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-purple btn-icon" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.bg-purple</code> classes</p>
							</div>
							...
							<div class="input-group">
								...
								<span class="input-group-append">
									<button class="btn bg-purple" type="button">Button</button>
								</span>									
							</div>
						</div>
			    	</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="purple-radio" checked data-fouc>
										Selected
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="purple-radio" data-fouc>
										Unselected
									</label>
								</div>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple">
							...
							<select class="form-control form-control-select2" data-container-css-class="text-purple" data-fouc>
			    ...
			    <div class="row">
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-solid bg-purple rounded-top border-0 mb-0">
								...
								<div class="tab-content card card-body rounded-top-0 mb-0">
									<div class="tab-pane fade active show" id="colored-nav-tab1">
										Add <code>custom</code> background color to the tab navigation with <code>.bg-purple</code> palette classes
									</div>
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-purple rounded-top-0 border-top-1 mb-0">
									<div class="tab-pane fade active show" id="colored-tab1">
										Add <code>custom</code> background color to the tabs navigation and content with <code>.bg-purple</code> palette classes
									</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<span class="text-purple">Purple text</span> and <a href="#" class="text-purple">purple link</a>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<span class="badge bg-purple">Purple badge</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<span class="badge bg-purple badge-pill">390</span>
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div class="progress">
								<div class="progress-bar bg-purple" style="width: 55%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped bg-purple" style="width: 65%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped progress-bar-animated bg-purple" style="width: 75%">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th>#</th>
											<th class="alpha-purple">First Name</th>
											<th>Last Name</th>
											<th class="bg-purple">Username</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td>1</td>
											<td class="alpha-purple">Eugene</td>
											<td>Kopyov</td>
											<td class="bg-purple">@Kopyov</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="alpha-purple">Victoria</td>
											<td>Baker</td>
											<td class="bg-purple">@Vicky</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="alpha-purple">James</td>
											<td>Alexander</td>
											<td class="bg-purple">@Alex</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button type="button" class="btn bg-purple"><i class="icon-menu7 mr-2"></i> Button</button>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button type="button" class="btn bg-purple btn-labeled btn-labeled-left">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button type="button" class="btn btn-outline bg-purple text-purple border-purple">
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card">
							<div class="card-header bg-purple header-elements-inline">
								<h6 class="card-title">Purple card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Purple card using <code>.bg-purple</code> class added to the card header
							</div>
						</div>
			    	</div>

			    	<div class="col-md-4">
			    		<div class="card border-1 border-purple">
							<div class="card-header header-elements-inline bg-purple">
								<h6 class="card-title">Purple bordered card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Bordered purple card using <code>.bg-purple</code> and <code>.border-purple</code> classes
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card bg-purple">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Purple solid card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Solid purple card using <code>.bg-purple</code> class added to the card container
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button type="button" class="btn bg-purple" data-popup="tooltip-custom" title="Purple tooltip" data-placement="bottom" data-container="body">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button type="button" class="btn bg-purple" data-popup="popover-custom" title="Purple popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover title
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button type="button" class="btn bg-purple" data-popup="popover-solid" title="Purple popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover background
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button type="button" class="btn bg-purple" data-toggle="modal" data-target="#modal_purple_header">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button type="button" class="btn bg-purple" data-toggle="modal" data-target="#modal_purple">
									<i class="icon-bubbles8 mr-2"></i>
									Modal background
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button type="button" class="btn bg-purple" data-toggle="modal" data-target="#modal_purple_footer">
									<i class="icon-bubbles8 mr-2"></i>
									Modal dialog footer
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<p class="mb-3 text-muted">Using <code>.bg-purple</code> color classes</p>

							<div>
								<button class="btn bg-purple noty-launch">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button class="btn bg-purple growl-launch">
									<i class="icon-bubbles6 mr-2"></i>
									jGrowl notification
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple text-center">
							...
							<div>
								<button class="btn bg-purple pnotify-launch">
									<i class="icon-bubbles6 mr-2"></i>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-purple</code> color classes</p>
							</div>

							<div class="dropdown-menu border-purple border-2" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-purple">
							...
							<div class="dropdown-menu bg-purple border-purple" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item"><i class="icon-menu7"></i> Action</a>
								<a href="#" class="dropdown-item"><i class="icon-screen-full"></i> Another action</a>
								<a href="#" class="dropdown-item"><i class="icon-mail5"></i> Something else here</a>
								<div class="dropdown-divider"></div>
			    		...
			    		<div class="card card-body border-top-purple">
							...
							<div class="dropdown-menu bg-purple border-purple" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item">
									<i class="icon-menu7"></i>
									Action
									<span class="badge bg-purple-800 ml-auto">Badge</span>
								</a>
								<a href="#" class="dropdown-item">
									<i class="icon-screen-full"></i>
									Another action
									<span class="badge badge-pill bg-purple-800 ml-auto">98</span>
								</a>
								<div class="dropdown-divider"></div>
				...
				<!-- Modal header -->
				<div id="modal_purple_header" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-purple">
								<h6 class="modal-title">Purple header</h6>
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn bg-purple">Save changes</button>
							</div>
						</div>
					</div>
				</div>
				...
				<!-- Solid modal -->
				<div id="modal_purple" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content bg-purple">
							<div class="modal-header">
								<h6 class="modal-title">Purple background</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
				...
				<!-- Modal footer -->
				<div id="modal_purple_footer" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h6 class="modal-title">Purple footer</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
	            ...
	            <!-- Purple 800 -->
				<div id="purple_800" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										...
										<td><code>.bg-purple-800</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-purple-800</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-purple-800</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-purple-800</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-purple-800</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-purple-800</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Purple 700 -->
				<div id="purple_700" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-purple-700</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-purple-700</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-purple-700</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-purple-700</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-purple-700</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-purple-700</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Purple 600 -->
				<div id="purple_600" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-purple-600</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-purple-600</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-purple-600</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-purple-600</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-purple-600</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-purple-600</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Purple 500 -->
				<div id="purple_500" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-purple</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-purple</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-purple</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Purple 400 -->
				<div id="purple_400" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-purple-400</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-purple-400</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-purple-400</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-purple-400</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-purple-400</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-purple-400</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Purple 300 -->
				<div id="purple_300" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-purple-300</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-purple-300</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-purple-300</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-purple-300</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-purple-300</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-purple-300</code></td>
									</tr>
								</table>
							</div>

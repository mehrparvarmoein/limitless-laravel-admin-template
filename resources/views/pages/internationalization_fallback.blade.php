...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/internationalization_fallback.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Translation</span> - Fallback Language</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="internationalization_fallback" class="breadcrumb-item">Translation</a>
						...
						<div class="navbar navbar-dark navbar-expand-md rounded mb-4">
							...
							<div class="collapse navbar-collapse" id="navbar-i18-demo">
								<ul class="navbar-nav">
									<li class="nav-item dropdown language-switch">
										...
										<div class="dropdown-menu">
											...
											<a href="?lng=es" class="dropdown-item spanish">
												<img src="../../../../global_assets/images/lang/es.png" class="img-flag" alt="">
												Spanish
											</a>
											<a href="?lng=it" class="dropdown-item italian">
								...
								<ul class="navbar-nav ml-md-auto language-switch">
									...
									<li class="nav-item">
										<a href="?lng=es" class="navbar-nav-link spanish">
											<img src="../../../../global_assets/images/lang/es.png" class="img-flag mr-2" alt="">
											Spanish
										</a>
									</li>
									<li class="nav-item">
										<a href="?lng=it" class="navbar-nav-link italian">
...
&lt;!-- /dropdown menu -->
							...
							<div class="col-md-6">
								...
								<pre class="mb-3" data-line="9"><code class="language-javascript">// Set init options
i18next

			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Content Sidebar</span> - Custom Color</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_content_color_custom" class="breadcrumb-item">Content sidebar</a>
							<span class="breadcrumb-item active">Custom color</span>
						</div>
				...
				<div class="d-flex align-items-start flex-column flex-md-row">
					...
					<div class="order-2 order-md-1">
						...
						<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
							...
							All sidebars support light and dark color palettes. By default content sidebar is light, if you want to change background color to some custom color from color system, add color helper class to <code>.sidebar-component</code> container and replace <code>.sidebar-light</code> class with <code>.sidebar-dark</code> class.
					    </div>
					    <!-- /info alert -->
...
&lt;!-- /mini sidebar layout -->
					...
					<div class="sidebar sidebar-dark bg-indigo-400 sidebar-component sidebar-component-right order-1 order-md-2 sidebar-expand-md">

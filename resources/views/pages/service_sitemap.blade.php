			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Service Pages</span> - Sitemap</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="service_sitemap" class="breadcrumb-item">Service pages</a>
						...
						<div class="row">
							...
							<div class="col-sm-6 col-lg-3">
								...
								<div class="mb-3">
									...
									<ul class="list list-unstyled">
										<li><a href="dimple_lines_horizontal">Lines - Horizontal orientation</a></li>
										<li><a href="dimple_lines_vertical">Lines - Vertical orientation</a></li>
										<li><a href="dimple_bars_horizontal">Bars - Horizontal orientation</a></li>
										<li><a href="dimple_bars_vertical">Bars - Vertical orientation</a></li>
										<li><a href="dimple_area_horizontal">Area - Horizontal orientation</a></li>
										<li><a href="dimple_area_vertical">Area - Vertical orientation</a></li>
										<li><a href="dimple_step_horizontal">Step - Horizontal orientation</a></li>
										<li><a href="dimple_step_vertical">Step - Vertical orientation</a></li>

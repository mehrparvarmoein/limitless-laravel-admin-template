...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/colors_green.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Green Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_green" class="breadcrumb-item">Colors</a>
							<span class="breadcrumb-item active">Green palette</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-green-800 demo-color"><span>green-800</span></div>

							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Green 800</strong>
										<div class="text-muted mt-1">#558B2F</div>
									</div>

									<div class="list-icons">
				                		<a href="#green_800" class="list-icons-item" data-toggle="modal">
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-green-700 demo-color"><span>green-700</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Green 700</strong>
										<div class="text-muted mt-1">#689F38</div>
									</div>

									<div class="list-icons">
				                		<a href="#green_700" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-green-600 demo-color"><span>green-600</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Green 600</strong>
										<div class="text-muted mt-1">#7CB342</div>
									</div>

									<div class="list-icons">
				                		<a href="#green_600" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-green demo-color"><span>green</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Green 500</strong>
										<div class="text-muted mt-1">#8BC34A</div>
									</div>

									<div class="list-icons">
				                		<a href="#green_500" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-green-400 demo-color"><span>green-400</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Green 400</strong>
										<div class="text-muted mt-1">#9CCC65</div>
									</div>

									<div class="list-icons">
				                		<a href="#green_400" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
					...
					<div class="col-sm-4 col-xl-2">
						<div class="card">
							<div class="bg-green-300 demo-color"><span>green-300</span></div>
							
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start">
									<div>
										<strong>Green 300</strong>
										<div class="text-muted mt-1">#AED581</div>
									</div>

									<div class="list-icons">
				                		<a href="#green_300" class="list-icons-item" data-toggle="modal">
				                			<i class="icon-menu7"></i>
				                		</a>
				                	</div>
			                	</div>
				...
				<div class="card">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<tr>
									<td><code>.bg-green</code><br><code>.bg-green-*</code></td>
									<td>Classes for background color. You can choose between 1 green color using <code>.bg-green</code> class and 5 accent colors using <code>.bg-green-*</code> class in 300, 400, 600, 700, 800 range</td>
								</tr>
								<tr>
									<td><code>.border-green</code><br><code>.border-green-*</code></td>
				...
				<div class="mb-3">
					...
					<!-- Basic alert -->
					<div class="alert alpha-green border-green text-green-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						Here you can see how green palette can be used with different components. By the way, this alert uses it as well
				    </div>
				    <!-- /basic alert -->


				    <!-- White alert -->
					<div class="alert bg-white border-green text-green-800 alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
						And this alert uses green color palette, but white background color. With utility classes, everything is possible
				    </div>
				    <!-- /white alert -->


				    <!-- Solid alert -->
				    <div class="alert bg-green alert-styled-left alert-dismissible">
						<button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green">
							<div class="text-center">
								<h6 class="m-0 font-weight-semibold">Input field text</h6>
								<p class="mb-3 text-muted">Using <code>.text-green</code> classes</p>
							</div>

							<input type="text" class="form-control text-green text-uppercase font-weight-semibold font-size-sm line-height-sm" value="Input field text">
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green">
							...
							<div class="form-group-feedback form-group-feedback-right">
								...
								<div class="form-control-feedback text-green">
									<i class="icon-help"></i>
								</div>
							</div>
						</div>
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-green">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-green"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text text-green"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-green btn-icon" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.bg-green</code> classes</p>
							</div>
							...
							<div class="input-group">
								...
								<span class="input-group-append">
									<button class="btn bg-green" type="button">Button</button>
								</span>									
							</div>
						</div>
			    	</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="green-radio" checked data-fouc>
										Selected
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-input-styled" name="green-radio" data-fouc>
										Unselected
									</label>
								</div>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green">
							...
							<select class="form-control form-control-select2" data-container-css-class="text-green" data-fouc>
			    ...
			    <div class="row">
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-solid bg-green rounded-top border-0 mb-0">
								...
								<div class="tab-content card card-body rounded-top-0 mb-0">
									<div class="tab-pane fade active show" id="colored-nav-tab1">
										Add <code>custom</code> background color to the tab navigation with <code>.bg-green</code> palette classes
									</div>
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-green rounded-top-0 border-top-1 mb-0">
									<div class="tab-pane fade active show" id="colored-tab1">
										Add <code>custom</code> background color to the tabs navigation and content with <code>.bg-green</code> palette classes
									</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<span class="text-green">Green text</span> and <a href="#" class="text-green">green link</a>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<span class="badge bg-green">Green badge</span>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<span class="badge bg-green badge-pill">390</span>
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div class="progress">
								<div class="progress-bar bg-green" style="width: 55%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped bg-green" style="width: 65%">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-striped progress-bar-animated bg-green" style="width: 75%">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th>#</th>
											<th class="alpha-green">First Name</th>
											<th>Last Name</th>
									...
									<tbody>
										<tr>
											<td>1</td>
											<td class="alpha-green">Eugene</td>
											<td>Kopyov</td>
											<td class="bg-green">@Kopyov</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="alpha-green">Victoria</td>
											<td>Baker</td>
											<td class="bg-green">@Vicky</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="alpha-green">James</td>
											<td>Alexander</td>
											<td class="bg-green">@Alex</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button type="button" class="btn bg-green"><i class="icon-menu7 mr-2"></i> Button</button>
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button type="button" class="btn bg-green btn-labeled btn-labeled-left">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button type="button" class="btn btn-outline bg-green text-green border-green">
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card">
							<div class="card-header bg-green header-elements-inline">
								<h6 class="card-title">Green card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Green card using <code>.bg-green</code> class added to the card header
							</div>
						</div>
			    	</div>

			    	<div class="col-md-4">
			    		<div class="card border-1 border-green">
							<div class="card-header header-elements-inline bg-green">
								<h6 class="card-title">Green bordered card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Bordered green card using <code>.bg-green</code> and <code>.border-green</code> classes
							</div>
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card bg-green">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Green solid card</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								Solid green card using <code>.bg-green</code> class added to the card container
							</div>
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button type="button" class="btn bg-green" data-popup="tooltip-custom" title="Green tooltip" data-placement="bottom" data-container="body">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button type="button" class="btn bg-green" data-popup="popover-custom" title="Green popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover title
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button type="button" class="btn bg-green" data-popup="popover-solid" title="Green popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
									<i class="icon-comment mr-2"></i>
									Popover background
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button type="button" class="btn bg-green" data-toggle="modal" data-target="#modal_green_header">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button type="button" class="btn bg-green" data-toggle="modal" data-target="#modal_green">
									<i class="icon-bubbles8 mr-2"></i>
									Modal background
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button type="button" class="btn bg-green" data-toggle="modal" data-target="#modal_green_footer">
									<i class="icon-bubbles8 mr-2"></i>
									Modal dialog footer
								</button>
							</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<p class="mb-3 text-muted">Using <code>.bg-green</code> color classes</p>

							<div>
								<button class="btn bg-green noty-launch">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button class="btn bg-green growl-launch">
									<i class="icon-bubbles6 mr-2"></i>
									jGrowl notification
								</button>
							</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green text-center">
							...
							<div>
								<button class="btn bg-green pnotify-launch">
									<i class="icon-bubbles6 mr-2"></i>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-green</code> color classes</p>
							</div>

							<div class="dropdown-menu border-green border-2" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-green">
							...
							<div class="dropdown-menu bg-green border-green" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item"><i class="icon-menu7"></i> Action</a>
								<a href="#" class="dropdown-item"><i class="icon-screen-full"></i> Another action</a>
								<a href="#" class="dropdown-item"><i class="icon-mail5"></i> Something else here</a>
								<div class="dropdown-divider"></div>
			    		...
			    		<div class="card card-body border-top-green">
							...
							<div class="dropdown-menu bg-green border-green" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
								<a href="#" class="dropdown-item">
									<i class="icon-menu7"></i>
									Action
									<span class="badge bg-green-800 ml-auto">Badge</span>
								</a>
								<a href="#" class="dropdown-item">
									<i class="icon-screen-full"></i>
									Another action
									<span class="badge badge-pill bg-green-800 ml-auto">98</span>
								</a>
								<div class="dropdown-divider"></div>
				...
				<!-- Modal header -->
				<div id="modal_green_header" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-green">
								<h6 class="modal-title">Green header</h6>
				...
				<!-- Solid modal -->
				<div id="modal_green" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content bg-green">
							<div class="modal-header">
								<h6 class="modal-title">Green background</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
				...
				<!-- Modal footer -->
				<div id="modal_green_footer" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h6 class="modal-title">Green footer</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
	            ...
	            <!-- Green 800 -->
				<div id="green_800" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										...
										<td><code>.bg-green-800</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-green-800</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-green-800</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-green-800</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-green-800</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-green-800</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Green 700 -->
				<div id="green_700" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-green-700</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-green-700</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-green-700</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-green-700</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-green-700</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Green 600 -->
				<div id="green_600" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-green-600</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-green-600</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-green-600</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-green-600</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-green-600</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-green-600</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Green 500 -->
				<div id="green_500" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-green</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-green</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-green</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-green</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-green</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
	            ...
	            <!-- Green 400 -->
				<div id="green_400" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									<tr>
										<td>Background color:</td>
										<td><code>.bg-green-400</code></td>
									</tr>
									<tr>
										<td>Border color:</td>
										<td><code>.border-green-400</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-green-400</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-green-400</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-green-400</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-green-400</code></td>
									</tr>
								</table>
							</div>
	            ...
	            <!-- Green 300 -->
				<div id="green_300" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Available options</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tr>
										<td>Border color:</td>
										<td><code>.border-green-300</code></td>
									</tr>
									<tr>
										<td>Border top color:</td>
										<td><code>.border-top-green-300</code></td>
									</tr>
									<tr>
										<td>Border bottom color:</td>
										<td><code>.border-bottom-green-300</code></td>
									</tr>
									<tr>
										<td>Border left color:</td>
										<td><code>.border-left-green-300</code></td>
									</tr>
									<tr>
										<td>Text color:</td>
										<td><code>.text-green-300</code></td>
									</tr>
								</table>
							</div>

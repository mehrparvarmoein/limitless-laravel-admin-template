						...
						<ul class="nav nav-sidebar" data-nav-type="accordion">
							...
							<li class="nav-item">
								<a href="#" class="nav-link">
									...
									Assigned to me
									<span class="badge bg-slate-800 badge-pill ml-auto">86</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link">
									...
									Assigned to my team
									<span class="badge bg-slate-800 badge-pill ml-auto">47</span>
								</a>
							</li>
							<li class="nav-item">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Secondary Custom</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_secondary_custom" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Secondary custom</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					All sidebars support light and dark color palettes. By default secondary sidebar is light, if you want to change background color to some custom color from color system, add color helper class to <code>.sidebar-secondary</code> container and replace <code>.sidebar-light</code> class with <code>.sidebar-dark</code> class.
				</div>
			    <!-- /info alert -->

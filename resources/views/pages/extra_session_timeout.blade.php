...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/extra_session_timeout.js"></script>
	<!-- /Page JS files -->
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Extra</span> - Session Timeout</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="extra_session_timeout" class="breadcrumb-item">Extra</a>
							<span class="breadcrumb-item active">Session timeout</span>
						</div>

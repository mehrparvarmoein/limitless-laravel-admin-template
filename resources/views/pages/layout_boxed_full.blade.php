...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/dashboard_boxed.js"></script>
	<!-- /Page JS files -->
			...
			<div class="collapse navbar-collapse" id="navbar-mobile">
				<ul class="navbar-nav">
					<li class="nav-item mega-menu-full">
						<a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown"><i class="icon-menu7 mr-2"></i> Navigation</a>

						<div class="dropdown-menu dropdown-content container mx-md-auto">
							<div class="dropdown-content-body">
								<div class="row">
									<div class="col-md-3">
										<div class="font-size-sm line-height-sm font-weight-semibold text-uppercase mt-1">Page layouts</div>
										<div class="dropdown-divider mb-2"></div>
										<div class="mb-3 mb-xl-0">
											<a href="layout_boxed_default" class="dropdown-item rounded">Boxed default</a>
											<a href="layout_boxed_mini" class="dropdown-item rounded">Boxed mini</a>
											<a href="layout_boxed_full" class="dropdown-item active rounded">Boxed full</a>
									...
									<div class="col-md-3">
										...
										<div class="dropdown-divider mb-2"></div>
										<div class="mb-3 mb-xl-0">
											<a href="sidebar_default_collapse" class="dropdown-item rounded">Main sidebar <span class="badge badge-pill bg-grey ml-auto">10+</span></a>
									...
									<div class="col-md-3">
										...
										<div class="mb-3 mb-xl-0">
											...
											<a href="navbar_colors" class="dropdown-item rounded">Navbar colors</a>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="d-flex align-items-center justify-content-center mb-2">
										<a href="#" class="btn bg-transparent border-primary text-primary rounded-round border-2 btn-icon mr-3">
									...
									<div class="chart w-75 mx-auto mb-3" id="new-visitors"></div>
								</div>
								...
								<div class="col-sm-4">
									...
									<div class="chart w-75 mx-auto mb-3" id="new-sessions"></div>
								</div>
								...
								<div class="col-sm-4">
									...
									<div class="chart w-75 mx-auto mb-3" id="total-online"></div>
								</div>
							</div>
						</div>

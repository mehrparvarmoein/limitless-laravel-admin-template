...
<head>
	...
	<script src="../../../../global_assets/js/demo_pages/fullcalendar_styling.js"></script>
	<!-- /Page JS files -->
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Fullcalendar</span> - Styling</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="fullcalendar_styling" class="breadcrumb-item">Fullcalendar</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Background events</h5>
						<div class="header-elements">
							<div class="list-icons">
		                		<a class="list-icons-item" data-action="collapse"></a>
		                		<a class="list-icons-item" data-action="reload"></a>
					...
					<div class="card-body">
						<p class="mb-3">Events that appear as background highlights can be achieved by setting an Event Object's <code>rendering</code> property to <code>background</code>. Background events that are <span class="font-weight-semibold">timed</span> will only be rendered on the time slots in agenda view. Background events that are <span class="font-weight-semibold">all-day</span> will only be rendered in month view or the all-day slots of agenda view. Also the spans of time <span class="font-weight-semibold">not</span> occupied by an event can be colored by setting the <code>rendering</code> property to <code>inverse-background</code>.</p>

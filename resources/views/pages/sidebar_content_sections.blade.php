			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Content Sidebar</span> - Sections</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_content_sections" class="breadcrumb-item">Content sidebar</a>
				...
				<div class="d-md-flex align-items-md-start">
					...
					<div>
						...
						<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
							...
							<h6 class="alert-heading font-weight-semibold mb-1">Sectioned sidebar</h6>
							Since all sidebars use <strong>card</strong> component for sidebar sections, it is possible to show cards inside sidebar as separate components. Just add <code>.bg-transparent</code> and <code>.border-0</code> classes to <code>.sidebar-component</code> container to remove background color and borders.
					    </div>
					    <!-- /info alert -->

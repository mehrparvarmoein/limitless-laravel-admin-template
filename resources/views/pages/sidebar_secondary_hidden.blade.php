	...
	<div class="navbar navbar-expand-md navbar-dark bg-indigo navbar-static">
		...
		<div class="collapse navbar-collapse" id="navbar-mobile">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a href="#" class="navbar-nav-link sidebar-control sidebar-secondary-toggle d-none d-md-block" data-popup="tooltip-demo" title="Show secondary" data-placement="bottom" data-container="body" data-trigger="hover">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Secondary Hidden</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_secondary_hidden" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Secondary hidden</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Hidden secondary sidebar</h6>
					If you want to hide secondary sidebar by default, just add <code>.sidebar-secondary-hidden</code> class to <code>&lt;body></code> container and use <code>.sidebar-secondary-toggle</code> class in sidebar control button to show/hide it.
			    </div>
			    <!-- /info alert -->

		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Right Visible</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_right_visible" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Right visible</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Right sidebar visible</h6>
					Right sidebar is hidden by default. You can make it visible by default by adding <code>.sidebar-right-visible</code> class to <code>&lt;body></code> container. Use <code>.sidebar-right-toggle</code> class to allow toggling.
			    </div>
			    <!-- /info alert -->

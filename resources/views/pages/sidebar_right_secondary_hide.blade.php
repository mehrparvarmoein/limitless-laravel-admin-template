	...
	<div class="navbar navbar-expand-md navbar-dark bg-indigo navbar-static">
		...
		<div class="collapse navbar-collapse" id="navbar-mobile">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a href="#" class="navbar-nav-link sidebar-control sidebar-right-secondary-toggle d-none d-md-block" data-popup="tooltip-demo" title="Show - hide secondary" data-placement="bottom" data-container="body" data-trigger="hover">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Right, Hide Secondary</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_right_secondary_hide" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Right, hide secondary</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Show right - hide secondary</h6>
					If you add <code>.sidebar-right-secondary-toggle</code> class to sidebar control button, secondary sidebar will get hidden when right sidebar is shown. This class doesn't affect main and content sidebars.
			    </div>
			    <!-- /info alert -->
...
&lt;!-- /mini sidebar layout -->
		...
		<div class="sidebar sidebar-light sidebar-right sidebar-expand-md">
			...
			<!-- Sidebar mobile toggler -->
			<div class="sidebar-mobile-toggler bg-blue-800 text-center">
				<a href="#" class="sidebar-mobile-expand">
					<i class="icon-screen-full"></i>
					<i class="icon-screen-normal"></i>
				</a>
			...
			<div class="sidebar-content">
				...
				<div class="card mb-2">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="#" class="nav-link"><i class="icon-reading"></i> My profile</a>
						</li>
						<li class="nav-item">
							<a href="#" class="nav-link"><i class="icon-coins"></i> Balance</a>
						</li>
						<li class="nav-item">
							<a href="#" class="nav-link">
								<i class="icon-bubble2"></i>
								Messages
								<span class="badge bg-primary badge-pill ml-auto">28</span>
							</a>
						</li>
						<li class="nav-item-header">Billing</li>
						<li class="nav-item">
							<a href="#" class="nav-link">
								<i class="icon-home4"></i>
								Addresses
								<span class="badge bg-dark badge-pill ml-auto">4</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="#" class="nav-link">
						...
						<li class="nav-item">
							<a href="#" class="nav-link">
								...
								My bank accounts
								<span class="badge bg-dark badge-pill ml-auto">6</span>
							</a>
						</li>
						<li class="nav-item-header">Security</li>
						<li class="nav-item">
							<a href="#" class="nav-link">
				...
				<div class="card mb-3">
					...
					<div class="card-footer d-flex align-items-center py-2">
						<a href="#" class="d-inline-block text-grey">All contacts</a>
						<a href="#" class="d-inline-block text-grey ml-auto"><i class="icon-gear"></i></a>
					</div>
				</div>
				<!-- /contacts -->

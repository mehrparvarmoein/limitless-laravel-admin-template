		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Main and Secondary</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_secondary_after" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Main and secondary</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Secondary after main</h6>
					Secondary sidebar layout type includes 2 separate sidebars that come one after another. Main sidebar must have <code>.sidebar-main</code> class and secondary - <code>.sidebar-secondary</code>. <strong>Note:</strong> mini sidebar toggling works only with main sidebar since main purpose of this feature is to toggle main navigation, not all available sidebar components.
			    </div>
			    <!-- /info alert -->
